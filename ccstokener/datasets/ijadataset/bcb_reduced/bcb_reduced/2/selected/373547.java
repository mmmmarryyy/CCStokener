...
class AcmSearchresultPageParser_2010May extends ParserCallback {
    ...
    public void handleStartTag(HTML.Tag tag, MutableAttributeSet attr, int pos) {
        ...
        if (tag.equals(HTML.Tag.TABLE)) {
            ...
            if (attrCount == 4 && "small-text".equals(val_class) && "center".equals(val_align) && "top".equals(val_valign) && "padding-left: 5px".equals(val_style)) {
