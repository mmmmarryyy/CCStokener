...
public class MIBTree {
    ...
    private static final String[][] SNMPv2_SMI = { { "org", "iso", "3" }, { "dod", "org", "6" }, { "internet", "dod", "1" }, { "directory", "internet", "1" }, { "mgmt", "internet", "2" }, { "mib-2", "mgmt", "1" }, { "transmission", "mib-2", "10" }, { "experimental", "internet", "3" }, { "private", "internet", "4" }, { "enterprises", "private", "1" }, { "security", "internet", "5" }, { "snmpV2", "internet", "6" }, { "snmpDomains", "snmpV2", "1" }, { "snmpProxys", "snmpV2", "2" }, { "snmpModules", "snmpV2", "3" } };

    private static final String[][] SNMPv2_MIB = { { "sysDescr", "system", "1" }, { "sysObjectID", "system", "2" }, { "sysUpTime", "system", "3" }, { "sysContact", "system", "4" }, { "sysName", "system", "5" }, { "sysLocation", "system", "6" }, { "sysServices", "system", "7" } };
    ...
    public int[] getOID(String name) {
        ...
        if (name.indexOf('.') != -1) {
            ...
            if (oid == null) {
                log.warn(name + " found in tree but unable to resolve OID." + " lastLookupFailure=" + this.lastLookupFailure);
                return null;
            }
        }
    ...
    private boolean parseMIB(InputStream is) throws IOException {
        ...
        while ((line = readLine()) != null) {
            ...
            if ((line.indexOf("SEQUENCE {") != -1) || (line.indexOf("CHOICE {") != -1)) {
                ...
                parseObjectIdentifier(line);
            } else if (second.equals("OBJECT-TYPE") || second.equals("MODULE-IDENTITY") || second.equals("OBJECT-IDENTITY")) {
                parseObjectType();
            }
        }
        if (log.isDebugEnabled()) {
