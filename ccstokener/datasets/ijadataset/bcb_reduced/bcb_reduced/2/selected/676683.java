    ...
    private static class TagLibraryImpl extends AbstractTagLibrary {
        ...
        public boolean containsTagHandler(String ns, String localName) {
            ...
            if (!result && _compositeLibraryName != null) {
                ...
                Resource compositeComponentResource = resourceHandler.createResource(localName + ".xhtml", _compositeLibraryName);
        ...
        public TagHandler createTagHandler(String ns, String localName, TagConfig tag) throws FacesException {
            ...
            if (tagHandler == null && containsNamespace(ns) && _compositeLibraryName != null) {
                ...
                Resource compositeComponentResource = new CompositeResouceWrapper(resourceHandler.createResource(resourceName, _compositeLibraryName));
                if (compositeComponentResource != null) {
                    ComponentConfig componentConfig = new ComponentConfigWrapper(tag, "javax.faces.NamingContainer", null);
    ...
    private static class LibraryHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            try {
                ...
                SAXException saxe = new SAXException("Error Handling [" + this.source + "@" + this.locator.getLineNumber() + "," + this.locator.getColumnNumber() + "] <" + qName + ">");
                saxe.initCause(e);
                throw saxe;
            }
        }
        ...
        public void error(SAXParseException e) throws SAXException {
            SAXException saxe = new SAXException("Error Handling [" + this.source + "@" + e.getLineNumber() + "," + e.getColumnNumber() + "]");
            saxe.initCause(e);
            throw saxe;
        }
