...
public class OcStorageUtility {
    ...
    private static String getToken() throws IOException {
        ...
        String alfrescoIp = singleton.getProperty(PropsKeys.ALFRESCO_URL);
        String alfrescoLoginUrl = singleton.getProperty(PropsKeys.ALFRESCO_LOGIN_URL);
        String alfrescoUsername = singleton.getProperty(PropsKeys.ALFRESCO_USERNAME);
        String alfrescoPassword = singleton.getProperty(PropsKeys.ALFRESCO_PASSWORD);
        URL alfresco = new URL(alfrescoIp + alfrescoLoginUrl + "?u=" + alfrescoUsername + "&pw=" + alfrescoPassword);
        BufferedReader in = new BufferedReader(new InputStreamReader(alfresco.openStream()));
