...
class CswRemoteRepository {
   ...
   */
    private void publish(Schema schema, String xml) throws IOException, ParserConfigurationException, SAXException, TransformerException {
        if (!schemaKeys.containsString(schema.getKey())) return;
   ...
   */
    private StringBuffer readCharacters(InputStream strm) throws IOException {
        StringBuffer sb = new StringBuffer();
   ...
   */
    private void sendData(HttpURLConnection httpCon, String data) throws IOException {
