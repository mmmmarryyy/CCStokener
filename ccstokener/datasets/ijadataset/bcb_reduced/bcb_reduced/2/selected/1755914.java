 ...
 */
public class SearchChronologicalSubDivisionAF extends javax.swing.JPanel implements javax.swing.event.CaretListener {

    /** Creates new form SearchPersonalNameAF */
    public SearchChronologicalSubDivisionAF() {
        initComponents();
        String[] col = { java.util.ResourceBundle.getBundle("Administration").getString("ChronologicalSubDivision") };
    ...
    private void bnewActionPerformed(java.awt.event.ActionEvent evt) {
        newgen.presentation.administration.NewChronologicalSubDivisionAFDialog npafd = new newgen.presentation.administration.NewChronologicalSubDivisionAFDialog();
    ...
    public Object[] getSelectedValuesWithKey() {
        ...
        if (selectedrow == -1) {
            ...
            retobj[0] = this.dtmSearch.getValueAt(selectedrow, 0).toString();
            retobj[1] = ((String[]) this.chronoid_libid.get(selectedrow))[0];
            retobj[2] = ((String[]) this.chronoid_libid.get(selectedrow))[1];
        }
        return retobj;
    }
    ...
    private java.util.ArrayList chronoid_libid = new java.util.ArrayList();
