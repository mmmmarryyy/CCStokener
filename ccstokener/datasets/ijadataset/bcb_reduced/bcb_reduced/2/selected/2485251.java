    ...
    public static void checkFileSetup() {
        ...
        if (Settings.FILE.exists() == false) {
            ...
            try {
                ...
                layer.addMapsAutocut("GM New York 16", new Google.GoogleMaps(), max, min, 16, null, 32000);
                layer.addMapsAutocut("GM New York 14", new Google.GoogleMaps(), max, min, 14, null, 32000);
