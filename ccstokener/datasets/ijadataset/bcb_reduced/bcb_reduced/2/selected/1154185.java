...
public class EncogAnalyst {
	 ...
	 */
    public final void analyze(final File file, final boolean headers, final AnalystFileFormat format) {
    ...
    public final void download() {
        final URL sourceURL = this.script.getProperties().getPropertyURL(ScriptProperties.HEADER_DATASOURCE_SOURCE_FILE);
