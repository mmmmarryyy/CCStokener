...
public class PluginManager {
    ...
    private static Hashtable<String, GenericPluginInterface> allPlugins = new Hashtable<String, GenericPluginInterface>();

    private Hashtable<String, GenericPluginInterface> activePlugins = new Hashtable<String, GenericPluginInterface>();
    ...
    public static void initialize(boolean load) {
        try {
            ...
            if (allPlugins.size() == 0) {
                ...
                for (int i = 0; i < searchPaths.length; i++) loadFile(searchPaths[i], load);
            }
    ...
    public void deactivatePlugins(PluginCallbackRegister register) {
        ...
        while (e.hasMoreElements()) ((GenericPluginInterface) e.nextElement()).deactivate(register);
    }
