...
import org.hlj.web.http.HttpClient;
 ...
 */
public final class HttpClientImpl extends DefaultHttpClient implements HttpClient {
    ...
    public InputStream doPost(String url, Map<String, String> data, String referer) {
        return doPost(url, data, referer, EncodeConstants.UTF_8);
    }
    ...
    public InputStream doPost(String url, Map<String, String> data) {
        return doPost(url, data, null, EncodeConstants.UTF_8);
    }
