...
public class DataSetInfo {
    ...
    public char[] getData() throws AddeURLException {
        if (status < 0) throw new AddeURLException("No data available");
        return data;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < data.length / 80; i++) {
            ...
            int insertPos = 17;
            if (numPos >= 10 && numPos < 100) insertPos = 16; else if (numPos >= 100 && numPos < 1000) insertPos = 15; else if (numPos > 1000) insertPos = 14;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < descriptors.length; i++) System.out.println(descriptors[i]);
    }
}
