...
public class VaviMfiFileReader extends MfiFileReader {
    ...
    /** */
    public MfiFileFormat getMfiFileFormat(InputStream stream) throws InvalidMfiDataException, IOException {
        return VaviMfiFileFormat.readFrom(stream);
    }

    /** */
    public MfiFileFormat getMfiFileFormat(File file) throws InvalidMfiDataException, IOException {
    ...
    /** */
    public Sequence getSequence(InputStream is) throws InvalidMfiDataException, IOException {
        VaviMfiFileFormat mff = VaviMfiFileFormat.readFrom(is);
        return mff.getSequence();
    }

    /** */
    public Sequence getSequence(File file) throws InvalidMfiDataException, IOException {
        InputStream is = new BufferedInputStream(new FileInputStream(file));
