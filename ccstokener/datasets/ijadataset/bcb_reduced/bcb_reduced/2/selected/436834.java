...
public class ExtendedImageRegistry {
    ...
    protected static String resourceURLPrefix = EMFEditPlugin.INSTANCE.getImage("full/obj16/Resource").toString() + "#";
...
class ImageWrapperImageDescriptor extends ImageDescriptor {
    ...
    public boolean equals(Object that) {
        return that instanceof ImageWrapperImageDescriptor && ((ImageWrapperImageDescriptor) that).image.equals(image);
    }
