        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (result) MapSourcesUpdater.log.info("Updated map sources file retrieved"); else MapSourcesUpdater.log.info("No new update available");
    ...
    public static void loadMapSourceProperties(Properties targetProp) {
        try {
            ...
            if (mapFile.isFile()) {
                ...
                MapSourcesUpdater.log.trace("mapsources.properties revisons (resource/file): " + resRev + " / " + fileRev);
