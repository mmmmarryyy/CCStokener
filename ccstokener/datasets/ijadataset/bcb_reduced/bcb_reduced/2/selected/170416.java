...
public class URLConnectionTest extends junit.framework.TestCase {
     ...
     */
    public void test_RequestProperty_case_insensitivity() throws MalformedURLException, IOException {
        URLConnection u = (URLConnection) (new URL("http://example.org/").openConnection());
        u.setRequestProperty("KEY", "upper");
        u.setRequestProperty("key", "lower");
        assertEquals("set for \"KEY\" is overwritten by set for \"key\"", "lower", u.getRequestProperty("KEY"));
        assertEquals("value can be retrieved by either key case", "lower", u.getRequestProperty("key"));
        assertEquals("value can be retrieved by arbitrary key case", "lower", u.getRequestProperty("kEy"));
        ...
        assertTrue("returned value list contains expected value", values.contains("lower"));
        u = (URLConnection) (new URL("http://example.org/").openConnection());
        u.setRequestProperty("key", "lower");
        u.setRequestProperty("KEY", "upper");
        assertEquals("set for \"key\" is overwritten by set for \"KEY\"", "upper", u.getRequestProperty("KEY"));
        assertEquals("value can be retrieved by either key case", "upper", u.getRequestProperty("key"));
        assertEquals("value can be retrieved by arbitrary key case", "upper", u.getRequestProperty("kEy"));
        props = u.getRequestProperties();
        values = props.get("key");
        assertNotNull("first key does have an entry", values);
        assertNull("second key does not have an entry", props.get("KEY"));
        assertEquals("returned value list is correct size", 1, values.size());
        assertTrue("returned value list contains expected value", values.contains("upper"));
        u = (URLConnection) (new URL("http://example.org/").openConnection());
        u.setRequestProperty("KEY", "value1");
        u.addRequestProperty("key", "value2");
        assertEquals("value for \"KEY\" is the last one added", "value2", u.getRequestProperty("KEY"));
        assertEquals("value can be retrieved by either key case", "value2", u.getRequestProperty("key"));
        assertEquals("value can be retrieved by arbitrary key case", "value2", u.getRequestProperty("kEy"));
        props = u.getRequestProperties();
        values = props.get("KEY");
        assertNotNull("first key does have an entry", values);
        assertNull("second key does not have an entry", props.get("key"));
        assertEquals("returned value list is correct size", 2, values.size());
        assertTrue("returned value list contains first value", values.contains("value1"));
        assertTrue("returned value list contains second value", values.contains("value2"));
        u = (URLConnection) (new URL("http://example.org/").openConnection());
        u.addRequestProperty("KEY", "value1");
        u.addRequestProperty("key", "value2");
        u.addRequestProperty("Key", "value3");
        assertEquals("value for \"KEY\" is the last one added", "value3", u.getRequestProperty("KEY"));
        assertEquals("value can be retrieved by another key case", "value3", u.getRequestProperty("key"));
        assertEquals("value can be retrieved by arbitrary key case", "value3", u.getRequestProperty("kEy"));
        props = u.getRequestProperties();
        values = props.get("KEY");
        assertNotNull("first key does have an entry", values);
        assertNull("second key does not have an entry", props.get("key"));
        ...
        assertTrue("returned value list contains first value", values.contains("value1"));
        assertTrue("returned value list contains second value", values.contains("value2"));
        assertTrue("returned value list contains second value", values.contains("value3"));
    }

    /**
     * @tests java.net.URLConnection#addRequestProperty(java.lang.String,java.lang.String)
     */
    public void test_addRequestPropertyLjava_lang_StringLjava_lang_String() throws IOException {
        ...
        URL fUrl1 = new URL("jar:file:" + resources.getPath() + "/hyts_att.jar!/");
    ...
    public void test_getContentEncoding() {
        assertNull("getContentEncoding failed: " + uc.getContentEncoding(), uc.getContentEncoding());
    }
    ...
    public void test_getContentLength() throws IOException {
        assertEquals("getContentLength failed: " + uc.getContentLength(), 25, uc.getContentLength());
    }
    ...
    public void test_getDate() {
        if (uc.getDate() == 0) {
            System.out.println("WARNING: server does not support 'Date', in test_getDate");
        } else {
            assertTrue("getDate gave wrong date: " + uc.getDate(), uc.getDate() > 930000000000L);
        }
    }
    ...
    public void test_getDefaultUseCaches() {
        ...
        assertFalse("getDefaultUseCaches should have returned false", uc.getDefaultUseCaches());
        uc.setDefaultUseCaches(true);
        assertTrue("getDefaultUseCaches should have returned true", uc.getDefaultUseCaches());
    ...
    public void test_getExpiration() {
        assertEquals("getExpiration returned wrong expiration", 0, uc.getExpiration());
    }
    ...
    public void test_getHeaderFieldDateLjava_lang_StringJ() {
        if (uc.getHeaderFieldDate("Date", 22L) == 22L) {
            System.out.println("WARNING: Server does not support 'Date', test_getHeaderFieldDateLjava_lang_StringJ not run");
            return;
        }
        assertTrue("Wrong value returned: " + uc.getHeaderFieldDate("Date", 22L), uc.getHeaderFieldDate("Date", 22L) > 930000000000L);
    ...
    public void test_getHeaderFieldKeyI() {
        ...
        assertTrue("Could not find header field key containing \"content-type\"", foundResponse);
    }
    ...
    public void test_getHeaderFieldLjava_lang_String() {
        ...
        if (hf != null) {
            assertNull("Wrong value returned for header field 'Content-Encoding': " + hf, hf);
        }
        hf = uc.getHeaderField("Content-Length");
        if (hf != null) {
            assertEquals("Wrong value returned for header field 'Content-Length': ", "25", hf);
        }
        hf = uc.getHeaderField("Content-Type");
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'Content-Type': " + hf, hf.contains("text/html"));
        }
        hf = uc.getHeaderField("content-type");
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'content-type': " + hf, hf.contains("text/html"));
        ...
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'Date': " + hf, Integer.parseInt(hf.substring(hf.length() - 17, hf.length() - 13)) >= 1999);
        }
        hf = uc.getHeaderField("Expires");
        if (hf != null) {
            assertNull("Wrong value returned for header field 'Expires': " + hf, hf);
        }
        hf = uc.getHeaderField("SERVER");
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'SERVER': " + hf + " (expected " + Support_Configuration.HomeAddressSoftware + ")", hf.equals(Support_Configuration.HomeAddressSoftware));
        }
        hf = uc.getHeaderField("Last-Modified");
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'Last-Modified': " + hf, hf.equals(Support_Configuration.URLConnectionLastModifiedString));
        }
        hf = uc.getHeaderField("accept-ranges");
        if (hf != null) {
            assertTrue("Wrong value returned for header field 'accept-ranges': " + hf, hf.equals("bytes"));
        }
        hf = uc.getHeaderField("DoesNotExist");
        if (hf != null) {
            assertNull("Wrong value returned for header field 'DoesNotExist': " + hf, hf);
        }
    }
    ...
    public void test_getIfModifiedSince() {
        ...
        assertEquals("Returned wrong ifModifiedSince value", 200, uc.getIfModifiedSince());
    }
    ...
    public void test_getLastModified() {
        ...
        assertTrue("Returned wrong getLastModified value.  Wanted: " + Support_Configuration.URLConnectionLastModified + " got: " + uc.getLastModified(), uc.getLastModified() == Support_Configuration.URLConnectionLastModified);
    }
    ...
    public void test_getOutputStream() throws Exception {
        ...
        try {
            ...
            assertTrue("Response to POST method invalid 2", response.equals(posted));
            ...
            assertTrue("Response to POST method invalid 3", response.equals(posted));
            u = new URL("http://localhost:" + port + "/");
            conn = (java.net.HttpURLConnection) u.openConnection();
            conn.setDoOutput(true);
            conn.setRequestMethod("POST");
    ...
    public void test_getPermission() throws Exception {
        ...
        assertTrue("Permission of wrong type: " + p.toString(), p instanceof java.net.SocketPermission);
        assertTrue("Permission has wrong name: " + p.getName(), p.getName().contains("localhost:" + port));
        ...
        assertTrue("Wrong file: permission 1:" + perm + " , " + result, result.equals(perm));
        fileUrl = new URL("file:/myfile/");
        perm = new FilePermission("/myfile", "read");
        result = fileUrl.openConnection().getPermission();
        assertTrue("Wrong file: permission 2:" + perm + " , " + result, result.equals(perm));
        fileUrl = new URL("file:///host/volume/file");
        perm = new FilePermission("/host/volume/file", "read");
        result = fileUrl.openConnection().getPermission();
        assertTrue("Wrong file: permission 3:" + perm + " , " + result, result.equals(perm));
        URL httpUrl = new URL("http://home/myfile/");
        assertTrue("Wrong http: permission", httpUrl.openConnection().getPermission().equals(new SocketPermission("home:80", "connect")));
        httpUrl = new URL("http://home2:8080/myfile/");
        assertTrue("Wrong http: permission", httpUrl.openConnection().getPermission().equals(new SocketPermission("home2:8080", "connect")));
        URL ftpUrl = new URL("ftp://home/myfile/");
        assertTrue("Wrong ftp: permission", ftpUrl.openConnection().getPermission().equals(new SocketPermission("home:21", "connect")));
        ftpUrl = new URL("ftp://home2:22/myfile/");
        assertTrue("Wrong ftp: permission", ftpUrl.openConnection().getPermission().equals(new SocketPermission("home2:22", "connect")));
        URL jarUrl = new URL("jar:file:myfile!/");
        perm = new FilePermission("myfile", "read");
        result = jarUrl.openConnection().getPermission();
        assertTrue("Wrong jar: permission:" + perm + " , " + result, result.equals(new FilePermission("myfile", "read")));
    }
    ...
    public void test_getRequestPropertyLjava_lang_String() {
        ...
        assertTrue("Wrong property returned: " + uc.getRequestProperty("Yo"), uc.getRequestProperty("Yo").equals("yo"));
        assertNull("Wrong property returned: " + uc.getRequestProperty("No"), uc.getRequestProperty("No"));
    }
    ...
    public void test_getUseCaches() {
        ...
        assertTrue("getUseCaches should have returned false", !uc.getUseCaches());
    ...
    public void test_guessContentTypeFromStreamLjava_io_InputStream() throws IOException {
        String[] headers = new String[] { "<html>", "<head>", " <head ", "<body", "<BODY ", "<!DOCTYPE html", "<?xml " };
        String[] expected = new String[] { "text/html", "text/html", "text/html", "text/html", "text/html", "text/html", "application/xml" };
        ...
        for (int i = 0; i < headers.length; i++) {
            for (String enc : encodings) {
                ...
                assertEquals("checking " + headers[i] + " with " + enc, expected[i], mime);
            }
        }
        try {
     ...
     *        java.lang.String)
     */
    public void test_setRequestPropertyLjava_lang_StringLjava_lang_String() throws MalformedURLException {
        MockURLConnection u = new MockURLConnection(new URL("http://www.apache.org"));
    ...
    public void test_toString() {
        assertTrue("Wrong toString: " + uc.toString(), uc.toString().indexOf("URLConnection") > 0);
    }
