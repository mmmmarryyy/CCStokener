...
public class JarUtils {
    ...
    public static File explodeJarFile(File jarFile, File directory, boolean localCopy, boolean createSubDirectory) throws IOException {
    ...
    public static File[] listJarFiles(File file, boolean addDirectoryName) throws IOException {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (addDirectoryName) files.add(new File(file.getParentFile(), entry.getName())); else files.add(new File(entry.getName()));
        }
