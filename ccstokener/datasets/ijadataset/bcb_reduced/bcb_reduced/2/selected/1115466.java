    ...
    */
    public Socket createSocket(InetAddress host, int port) throws IOException {
        ...
        if (super.isEnabled() && (super.getSSLContext() != null)) {
            ...
            if (wrappedSocket != null) return super.getSSLContext().getSocketFactory().createSocket(wrappedSocket, hostString, port, true); else return super.getSSLContext().getSocketFactory().createSocket(host, port);
        } else if (super.isEnabled() && (super.getSSLContext() == null)) {
            if (super.isDebugMode()) logDebug("Creating socket for address: " + host + ", port: " + port + ". Using default javax.net.ssl.SSLSocketFactory.");
            if (wrappedSocket != null) return ((javax.net.ssl.SSLSocketFactory) javax.net.ssl.SSLSocketFactory.getDefault()).createSocket(wrappedSocket, hostString, port, true); else return javax.net.ssl.SSLSocketFactory.getDefault().createSocket(host, port);
        } else {
    ...
    */
    public Socket createSocket(InetAddress host, int port, InetAddress localAddress, int localPort) throws IOException {
        ...
        if (super.isEnabled() && (super.getSSLContext() != null)) {
            ...
            if (wrappedSocket != null) return super.getSSLContext().getSocketFactory().createSocket(wrappedSocket, hostString, port, true); else return super.getSSLContext().getSocketFactory().createSocket(host, port, localAddress, localPort);
        } else if (super.isEnabled() && (super.getSSLContext() == null)) {
            ...
            if (wrappedSocket != null) return ((javax.net.ssl.SSLSocketFactory) javax.net.ssl.SSLSocketFactory.getDefault()).createSocket(wrappedSocket, hostString, port, true); else return javax.net.ssl.SSLSocketFactory.getDefault().createSocket(host, port, localAddress, localPort);
        } else {
