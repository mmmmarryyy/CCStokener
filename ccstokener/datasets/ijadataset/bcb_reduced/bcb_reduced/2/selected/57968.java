 ...
 */
public class NewMeetingNameSHAFInternalFrame extends javax.swing.JInternalFrame {

    /** Creates new form NewMeetingNameSHAFInternalFrame */
    public NewMeetingNameSHAFInternalFrame() {
        initComponents();
        ...
        this.meetingnamepanel = new newgen.presentation.administration.MeetingNameAFSH();
        this.addPanel.add(this.meetingnamepanel);
        this.meetingnamepanel.setFromSearch();
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
    }

    public static NewMeetingNameSHAFInternalFrame getInstance() {
        if (thisScreen == null) {
            thisScreen = new newgen.presentation.administration.NewMeetingNameSHAFInternalFrame();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("NewMeetingNameSubjectHeading"));
    ...
    private static NewMeetingNameSHAFInternalFrame thisScreen;

    private newgen.presentation.administration.MeetingNameAFSH meetingnamepanel;
}
