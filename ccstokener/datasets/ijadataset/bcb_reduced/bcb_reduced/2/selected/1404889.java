...
public class RiXmlUtils {
    ...
    */
    public static Document readXml(InputStream is, String id) throws UnknownRtException {
        ...
        try {
            ...
            throw new UnknownRtException("Error parsing XML file: " + id + "line: " + spe.getLineNumber() + ", uri: " + spe.getSystemId(), spe);
    ...
    */
    ...
    public static Element getNode(Node node, String xPath, Map<String, String> prefixes) {
        ...
        if (nl != null) {
            if (nl.size() > 1) throw new UnknownRtException("More than 1 node found for xPath " + xPath);
            if (nl.size() == 1) return nl.get(0);
        }
        return null;
    }
    ...
    public static Document createDocument() {
        ...
        try {
            ...
            if (element != null) element.normalize();
        } catch (Throwable t) {
            t.printStackTrace();
        }
        return doc;
