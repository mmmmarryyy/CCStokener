...
public class MyWebServiceImplementation extends DefaultWebServiceWs2 {
    ...
    */
    ...
    protected Metadata doGet(String url) throws WebServiceException, MbXMLException {
        ...
        while (repeat) {
            ...
            if (md == null && trial > maxtrial) {
                String em = "ABORTED: web service returned " + HttpStatus.SC_SERVICE_UNAVAILABLE + "status '503' " + maxtrial + " time consecutively";
                log.error(em);
    ...
    private String buildMessage(HttpResponse response, String status) {
        ...
        if (reasonPhrase == null || reasonPhrase.isEmpty()) reasonPhrase = status;
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(MyWebServiceImplementation.class.getName()).log(Level.SEVERE, convertInputStreamToString(instream), ex);
            }
