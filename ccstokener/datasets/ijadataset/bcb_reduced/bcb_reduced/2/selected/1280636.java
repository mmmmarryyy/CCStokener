...
import ejb.bprocess.util.SendEmail;
import ejb.bprocess.util.SystemFilesLoader;
...
public class SearchViewAction extends Action {
    ...
    private ejb.bprocess.opac.xcql.OPACUtilitiesHome opacHm;

    private ejb.bprocess.opac.xcql.SearchSRUWCatalogueHome home;

    private String searchmode = "B";

    private ejb.bprocess.util.Utility utility = null;

    private newgenlib.marccomponent.conversion.Converter converter = new Converter();

    /** Creates a new instance of SearchViewAction */
    ...
    private String limitsSolrQuery(Hashtable hs) {
        String limitsQuery = "";
        try {
