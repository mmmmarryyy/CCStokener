 ...
 * @author  Siddarth1
 */
public class NewGeneralSubDivisionAF extends javax.swing.JInternalFrame {

    /** Creates new form NewGenInternalFrame */
    private NewGeneralSubDivisionAF() {
        initComponents();
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
    }

    public static NewGeneralSubDivisionAF getInstance() {
        if (thisScreen == null) {
            thisScreen = new NewGeneralSubDivisionAF();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("NewGeneralSubDivision"));
    ...
    private static NewGeneralSubDivisionAF thisScreen;
}
