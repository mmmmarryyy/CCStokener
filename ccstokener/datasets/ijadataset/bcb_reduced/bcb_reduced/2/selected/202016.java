 ...
 */
public class UnicodeTest extends javax.swing.JFrame {

    /** Creates new form UnicodeTest */
    public UnicodeTest() {
        initComponents();
    ...
    private void initComponents() {
        ...
        unicodeTextField1.setColumns(15);
        jPanel2.add(unicodeTextField1);
        jList1.setFont(new java.awt.Font("Arial Unicode MS", 1, 12));
...
class MyTask extends java.util.TimerTask {
    ...
    public void run() {
        System.out.println("Present Time is: " + (System.currentTimeMillis()) / 1000);
    }
}
