...
public class SettingsDialog extends JDialog implements ActionListener {
    ...
    public SettingsDialog(Suku owner) throws SukuException {
        ...
        String[] dateFormats = Resurses.getString("LOCALIZAT_DATEFORMATS").split(";");
        ...
        String databaseViewFontSize = Suku.kontroller.getPref(owner, "DB_VIEW_FONTSIZE", "11");
        String scaleImageText = Suku.kontroller.getPref(owner, "SCALE_IMAGE", "0");
