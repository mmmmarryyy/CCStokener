...
public class GLCgShader extends GLShader {
   ...
   *        ...
   */
    public void setMatParameter(String name, float m00, float m01, float m10, float m11) {
        CGparameter p = CgGL.cgGetNamedParameter(currProgram, name);
        if (p != null) {
   ...
   *        ...
   */
    public void setMatParameter(String name, float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22) {
        CGparameter p = CgGL.cgGetNamedParameter(currProgram, name);
        if (p != null) {
   ...
   *        ...
   */
    public void setMatParameter(String name, float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) {
        CGparameter p = CgGL.cgGetNamedParameter(currProgram, name);
        if (p != null) {
   ...
   */
    ...
    private void createVertexProgram(String source, String file) {
        ...
        if (vertexProfile == CgGL.CG_PROFILE_UNKNOWN) System.err.println("GLCgShader:  Vertex profile could not be created"); else CgGL.cgGLSetOptimalOptions(vertexProfile);
        ...
        if (!vertexShaderEnabled) {
            System.err.println("GLCgShader: Failed to loaded vertex program: " + file);
        }
    }
    ...
    private void createGeometryProgram(String source, String file) {
        ...
        geometryShaderEnabled = (geometryProgram != null) && (geometryProfile != CgGL.CG_PROFILE_UNKNOWN);
        if (!geometryShaderEnabled) {
            System.err.println("GLCgShader:  Failed to loaded geometry program: " + file);
        }
    }

    private void createFragmentProgram(String source, String file) {
        fragmentProfile = CgGL.cgGLGetLatestProfile(CgGL.CG_GL_FRAGMENT);
        if (fragmentProfile == CgGL.CG_PROFILE_UNKNOWN) System.err.println("GLCgShader:  Fragment profile could not be created"); else CgGL.cgGLSetOptimalOptions(fragmentProfile);
        ...
        if (!fragmentShaderEnabled) {
            System.err.println("GLCgShader:  Failed to loaded fragment program: " + file);
        }
    }
