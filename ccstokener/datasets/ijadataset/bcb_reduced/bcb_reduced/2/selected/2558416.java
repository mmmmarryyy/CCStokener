...
public class SumoHttpRetriever {
    ...
    public void fetchAndParse() throws IOException, SAXException {
        ...
        for (String inputFileName : inputFiles) {
            if (inputFileName.contains("/") || inputFileName.contains("\\")) throw new UnsupportedOperationException("path separators are not supported yet");
...
class ConfigFileContentHandler extends DefaultHandler {
    ...
    private static final String[] INPUT_FILE_ELEMENTS = new String[] { "net-file", "route-files", "additional-files", "weight-files" };
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        if (!readingInput) {
            if (localName.equals(INPUT_ELEMENT)) readingInput = true;
        } else {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (readingInput && localName.equals(INPUT_ELEMENT)) readingInput = false;
    }
