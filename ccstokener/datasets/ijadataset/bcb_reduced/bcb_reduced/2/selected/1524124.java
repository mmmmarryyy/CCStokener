...
public class FileUploader {
    ...
    /**
	 * Upload stream to the server 
	 * @param src			source stream to upload
	 * @param id			parameter name, e.g. "f"
	 * @param filename		file name, can be empty string
	 * @param contentype	MIME content type, e.g. application/octet-stream
	 * @param url			upload file page
	 * @param timeout		connect and receive time out in ms
	 * @param user			login
	 * @param password		password
	 * @return				URL 302 moved
	 */
