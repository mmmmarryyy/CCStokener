package org.nakedobjects.snapshot;
...
public class WebSnapshotAppender extends SnapshotAppender {
     ...
     */
    public WebSnapshotAppender(final String version) {
        super(version);
    }

    public WebSnapshotAppender(final String version, final TriggeringEventEvaluator evaluator) {
        super(version, evaluator);
    }
