...
public class AolImpl implements AuthProvider, Serializable {
    ...
    public String getLoginRedirectURL(final String redirectUri) {
        ...
        return "https://api.screenname.aol.com/auth/login?f=qs" + "&succUrl=" + redirectUri + "&devId=" + dev_id;
    }
    ...
    public Profile verifyResponse(final HttpServletRequest request) {
        try {
            ...
            String getInfoUrl = "https://api.screenname.aol.com/auth/getInfo?" + "f=qs" + "&devId=" + dev_id + "&referer=" + redirectUri + "&a=" + encodedToken;
    ...
    private Map getHttpResponseParameters(final String Url) throws MalformedURLException, IOException {
