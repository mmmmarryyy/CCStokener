...
public class ConnectionCertificateHandler {
    ...
    public static TrustManager[] createTrustManagers(final KeyStore keystore, SecureConnectionDescription scd) throws KeyStoreException, NoSuchAlgorithmException {
        if (keystore == null) throw new IllegalArgumentException("Keystore may not be null");
