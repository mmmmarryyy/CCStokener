package org.extwind.osgi.http.filter.internal;
...
public class ServletContextAdaptor implements ServletContext {
    ...
    /**
	 * @see javax.servlet.ServletContext#getResourcePaths(java.lang.String) This
	 *      method was added in the Servlet 2.3 API however the OSGi HttpService
	 *      currently does not provide support for this method in the
	 *      HttpContext interface. To support "getResourcePaths(...) this
	 *      implementation uses reflection to check for and then call the
	 *      associated HttpContext.getResourcePaths(...) method
	 *      opportunistically. Null is returned if the method is not present or
	 *      fails.
	 */
