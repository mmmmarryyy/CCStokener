...
public class OAuthClient {
    ...
    public static enum ParameterStyle {
        ...
        AUTHORIZATION_HEADER(net.oauth.ParameterStyle.AUTHORIZATION_HEADER), BODY(net.oauth.ParameterStyle.BODY), QUERY_STRING(net.oauth.ParameterStyle.QUERY_STRING);
