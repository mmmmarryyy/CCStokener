...
public class NetClientHandler extends NetHandler {
    ...
    public void handleEntityVelocity(Packet28EntityVelocity par1Packet28EntityVelocity) {
        ...
        if (entity == null) {
            ...
            if (PhantomVariables.phantomMods && PhantomVariables.autoFish && entity instanceof EntityFishHook) if (entity.motionX == 0 && entity.motionY != 0 && entity.motionZ == 0) {
                addToSendQueue(new Packet15Place(-1, -1, -1, 255, null));
            }
            return;
        }
    }
