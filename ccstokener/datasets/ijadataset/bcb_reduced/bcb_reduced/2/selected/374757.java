...
public class ExampleRunner extends JFrame {
    ...
    private static final String HEADER = "<html><body><h2 align=\"center\">Ardor3d Examples</h2>" + "<p>Choose an example in the tree and select Run. Movement keys are: W, A, S, and D. Control view with left/right buttons.</p>" + "<p align=\"center\"><img src=\"" + ExampleRunner.class.getResource("/com/ardor3d/example/media/images/ardor3d_white_256.jpg") + "\"></p></body></html>";
    ...
    private void updateDescription() {
        ...
        if (selectedClass == null) {
            ...
            if ("".equals(imgURL)) {
                imgURL = "<img src=\"" + ExampleRunner.class.getResource("/com/ardor3d/example/media/images/ardor3d_white_256.jpg") + "\"/>";
            }
    ...
    private String getHtmlDescription(final Purpose purpose) {
        ...
        try {
            final ResourceBundle bundle = ResourceBundle.getBundle(purpose.localisationBaseFile(), Locale.getDefault(), getClass().getClassLoader());
