 ...
 */
public class GoogleDistanceCalculator implements DistanceCalculatorIfc<String> {
    ...
    protected static final UtilLogger logger = new UtilLogger("GoogleDistanceCalculator");
    ...
    private double getCountFromQuery(BufferedReader reader) throws JSONException, IOException {
