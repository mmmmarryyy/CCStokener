 ...
 */
public class NewMeetingNameAFInternalFrame extends javax.swing.JInternalFrame {

    /** Creates new form NewMeetingNameAFInternalFrame */
    private NewMeetingNameAFInternalFrame() {
        initComponents();
        ...
        this.meetingnamepanel = new newgen.presentation.administration.MeetingNameAF();
        this.addpanel.add(this.meetingnamepanel, java.awt.BorderLayout.CENTER);
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
    }

    public static NewMeetingNameAFInternalFrame getInstance() {
        if (thisScreen == null) {
            thisScreen = new NewMeetingNameAFInternalFrame();
            thisScreen.setSize(620, 250);
            thisScreen.show();
        } else {
            thisScreen.setSize(620, 250);
            thisScreen.show();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("NewMeetingName"));
    ...
    private newgen.presentation.administration.MeetingNameAF meetingnamepanel;

    private static NewMeetingNameAFInternalFrame thisScreen;
}
