...
public class HttpResponseUtils {
    ...
    */
    public static String getContentType(String file) {
        ...
        if (foundContentType != null) return foundContentType; else return "application/octet-stream";
    }
    ...
    */
    public static HttpResponse createNameResponse(final TcpConnection connection) throws IOException {
        ...
        HttpResponse rsp;
        if (JServer.getJServer() != null) rsp = new HttpResponse(200, "OK", JServer.getJServer().getName()); else rsp = new HttpResponse(200, "OK", "Unknown");
        rsp.setContentType("text/html");
        return rsp;
    }
    ...
    * @exception IOException if there was an error writing to the socket.
    */
    public static HttpResponse createResponse(final int responseCode, final String responseDescription, final String body, final TcpConnection connection) throws IOException {
        HttpResponse rsp;
    ...
    * @exception IOException if there was an error writing to the socket.
    */
    public static HttpResponse createResponse(final int responseCode, final String responseDescription, final String body, final String contentType, final TcpConnection connection) throws IOException {
        HttpResponse rsp;
        rsp = new HttpResponse(responseCode, responseDescription, body);
        rsp.setContentType(contentType);
        return rsp;
    ...
    * @exception IOException if there was an error writing to the socket.
    */
    public static HttpResponse createResourceResponse(String resourceName, final boolean sendFileNotFound, final TcpConnection connection) throws IOException {
    ...
    */
    private static HttpResponse createInputStreamResponse(final InputStream input, final String contentType, final long length, final TcpConnection connection) throws IOException {
        HttpResponse rsp = new HttpResponse(200, "OK", input, length);
        if ((contentType != null) && (!contentType.equals(""))) rsp.setContentType(contentType); else rsp.setContentType("text/html");
        return rsp;
    }
}
