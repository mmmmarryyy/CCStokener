...
public class ZIPResource {
    ...
    private static HashMap<String, byte[]> zipLazy = new HashMap<String, byte[]>(LSystem.DEFAULT_MAX_CACHE_SIZE);

    private static ArrayList<ZipFile> zipFiles = new ArrayList<ZipFile>(CollectionUtils.INITIAL_CAPACITY);
