package com.apelon.selext.db.config;
...
public class MatchLoadConfig implements DBSystemConfig {
    ...
    private String MATCH_SPEC_TABLE = "MATCH_SPEC";

    private String MATCH_DB_TABLE = "MATCH_DB";
    ...
    public String getDaoDTDURL() {
        return "http://apelon.com/dtd/selext/" + DTD;
    }

    public Class getDaoDTDClass() {
        return com.apelon.selext.db.config.MatchLoadConfig.class;
    }
   ...
   */
    public InputStream getTableLists() throws IOException {
        String sb = new String("<?xml version=\"1.0\" ?>" + "<!DOCTYPE DTSDbConfig SYSTEM \"matchconfig.dtd\">" + "<DTSDbConfig>" + "<property name=\"prefix\" value=\"com.apelon.selext.db.Table\" />" + "<table name=\"" + MATCH_SPEC_TABLE + "\" />" + "<table name=\"" + MATCH_DB_TABLE + "\" />" + "</DTSDbConfig>");
