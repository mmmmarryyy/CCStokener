...
public class MaexoMBeanTests extends MaexoTests {
	 ...
	 */
    protected ObjectName getObjectName(Object resource, Class<?> resourceInterface) {
        ObjectNameFactoryHelper objectNameFactoryHelper = new ObjectNameFactoryHelper(this.bundleContext);
        return objectNameFactoryHelper.getObjectName(resource, resourceInterface);
    }
	 ...
	 * @return The object name.
	 */
    protected ObjectName getObjectName(Object resource, Class<?> resourceInterface, Map<String, Object> properties) {
        ObjectNameFactoryHelper objectNameFactoryHelper = new ObjectNameFactoryHelper(this.bundleContext);
        return objectNameFactoryHelper.getObjectName(resource, resourceInterface, properties);
    }
    ...
    protected Object getMBean(ObjectName objectName, Class<?> mbeanInterface) {
        ...
        final Object mBean = MBeanServerInvocationHandler.newProxyInstance(mbeanServerConnection, objectName, mbeanInterface, false);
        return mBean;
    }
