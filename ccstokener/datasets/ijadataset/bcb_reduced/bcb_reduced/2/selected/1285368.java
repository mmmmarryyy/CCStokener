...
public class SOAPConnectionImpl extends SOAPConnection {
    ...
    public SOAPMessage call(SOAPMessage request, Object endpoint) throws SOAPException {
        ...
        options.setProperty(Constants.Configuration.CHARACTER_SET_ENCODING, request.getProperty(SOAPMessage.CHARACTER_SET_ENCODING));
    ...
    private SOAPMessage getSOAPMessage(org.apache.axiom.soap.SOAPEnvelope respOMSoapEnv) throws SOAPException {
        ...
        if (header2 != null) {
            for (Iterator hbIter = header2.examineAllHeaderBlocks(); hbIter.hasNext(); ) {
                ...
                final SOAPHeaderElement headerEle = header.addHeaderElement(env.createName(hbQName.getLocalPart(), hbQName.getPrefix(), hbQName.getNamespaceURI()));
     ...
     */
    private void toSAAJElement(SOAPElement saajEle, OMNode omNode, javax.xml.soap.SOAPMessage saajSOAPMsg) throws SOAPException {
        ...
        if (omNode instanceof OMElement) {
            ...
            for (Iterator childIter = omEle.getChildren(); childIter.hasNext(); ) {
                ...
                if (omChildNode instanceof OMText) {
                    ...
                    for (Iterator attribIter = omChildEle.getAllAttributes(); attribIter.hasNext(); ) {
                        OMAttribute attr = (OMAttribute) attribIter.next();
                        final QName attrQName = attr.getQName();
    ...
    protected org.apache.axiom.soap.SOAPEnvelope toOMSOAPEnvelope(SOAPMessage saajSOAPMsg) throws SOAPException {
        final org.apache.axiom.soap.SOAPEnvelope omSOAPEnv = SAAJUtil.toOMSOAPEnvelope(saajSOAPMsg.getSOAPPart().getDocumentElement());
    ...
    private void insertAttachmentNodes(Map attachments, OMElement omEnvelope, HashMap keyAccessStatus) throws SOAPException {
        ...
        while (childIter.hasNext()) {
            ...
            if (contentID != null) {
                ...
                OMText text = new OMTextImpl(ap.getDataHandler(), true, omEnvelope.getOMFactory());
