...
public class BuzzIO {
     ...
     * @throws BuzzIOException if any IO error occurs ( networking ).
     */
    public static HttpsURLConnection createRequest(String feedUrl, String httpMethod) throws BuzzIOException {
     ...
     * @throws BuzzIOException if any IO error occurs ( networking ).
     */
    public static HttpsURLConnection createRequest(String feedUrl) throws BuzzIOException {
     ...
     * @throws BuzzIOException if any IO error occurs ( networking ).
     */
    public static HttpsURLConnection addBody(HttpsURLConnection request, String body) throws BuzzIOException {
        try {
     ...
     * @throws BuzzIOException if any IO error occurs ( networking ).
     */
    public static String send(HttpsURLConnection request) throws BuzzIOException {
