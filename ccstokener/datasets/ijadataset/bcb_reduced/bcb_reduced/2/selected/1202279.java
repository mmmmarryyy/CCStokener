...
public class ItemServer {
    ...
    static {
        if (System.getProperty("java.security.policy") == null) System.setProperty("java.security.policy", "server.policy");
   ...
   */
    public ItemServer(String host, int port, String codebase) {
        ...
        if (System.getProperty("java.rmi.server.codebase") != null) codebase += ' ' + System.getProperty("java.rmi.server.codebase");
    ...
    public static Remote bind(Object item, String name, Object proxy, RMIServerSocketFactory ssf, RMIClientSocketFactory csf, int port) throws RemoteException, IOException {
        ...
        synchronized (ItemServer.class) {
            if (csf == null || ssf == null) {
                if (registry == null) registry = LocateRegistry.createRegistry(Remote.getDefaultServerPort(), Remote.getDefaultClientSocketFactory(), Remote.getDefaultServerSocketFactory());
   ...
   */
    public static void main(String args[]) throws Exception {
        ...
        acceptProxies();
        System.out.println("Server started: " + DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL).format(new java.util.Date()));
