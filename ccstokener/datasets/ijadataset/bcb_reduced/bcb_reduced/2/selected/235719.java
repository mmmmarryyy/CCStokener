...
import com.nodeshop.bean.TenpayConfig;
import com.nodeshop.bean.SystemConfig.StoreFreezeTime;
import com.nodeshop.bean.TenpayConfig.TenpayType;
import com.nodeshop.entity.Deposit;
import com.nodeshop.entity.Member;
import com.nodeshop.entity.Order;
import com.nodeshop.entity.OrderItem;
import com.nodeshop.entity.OrderLog;
import com.nodeshop.entity.Payment;
import com.nodeshop.entity.PaymentConfig;
import com.nodeshop.entity.Product;
import com.nodeshop.entity.Deposit.DepositType;
import com.nodeshop.entity.Order.OrderStatus;
import com.nodeshop.entity.OrderLog.OrderLogType;
import com.nodeshop.entity.Payment.PaymentStatus;
import com.nodeshop.entity.Payment.PaymentType;
import com.nodeshop.entity.PaymentConfig.PaymentConfigType;
import com.nodeshop.service.DepositService;
import com.nodeshop.service.HtmlService;
import com.nodeshop.service.OrderLogService;
import com.nodeshop.service.OrderService;
import com.nodeshop.service.PaymentConfigService;
import com.nodeshop.service.PaymentService;
import com.nodeshop.service.ProductService;
 ...
 * KEY: nodeshop0D8A50887A9F4C77410AE65149244875
 
 */
@ParentPackage("member")
@InterceptorRefs({ @InterceptorRef(value = "token", params = { "excludeMethods", "confirm,tenpayReturn" }), @InterceptorRef(value = "memberStack") })
public class PaymentAction extends BaseShopAction {
    ...
    public String tenpayReturn() throws Exception {
        ...
        if (StringUtils.equals(pay_result, "0")) {
            ...
            BigDecimal totalAmount = new BigDecimal(total_fee).divide(new BigDecimal("100"));
            if (totalAmount.compareTo(payment.getTotalAmount()) != 0) {
                addActionError("交易金额错误！");
                return ERROR;
            }
            amountPayable = totalAmount.subtract(payment.getPaymentFee());
