package ca.ansir.analytics.cache;
...
public class DocumentCacheFactory {
	 ...
	 * &lt;analytics&gt; 
	 * &lt;documentcache
	 * classname=&quot;ca.ansir.analytics.cache.impl.FileDocumentCacheOld&quot;&gt;
	 ...
	 *             <code>DocumentCacheFactory</code>.
	 */
    public static void loadConfig(String className, Properties config) throws CacheException {
        try {
            initializeDocumentCacheFactory(className, config);
        } catch (ClassNotFoundException e) {
            throw new CacheException("Could not find '" + className + "'", e);
        } catch (InstantiationException e) {
            throw new CacheException("Could not instantiate '" + className + "'", e);
	 ...
	 * @throws CacheException
	 */
    private static void initializeDocumentCacheFactory(String className, Properties config) throws ClassNotFoundException, InstantiationException, IllegalAccessException, CacheException {
    ...
    public static class DocumentCacheAdapter implements DocumentCache {
        ...
        public void cacheDocument(Document document, CachedDocumentId id) throws CacheException {
        }

        public InputStream getDocumentAsInputStream(CachedDocumentId id) throws CacheException {
            return null;
        }
    }
}
