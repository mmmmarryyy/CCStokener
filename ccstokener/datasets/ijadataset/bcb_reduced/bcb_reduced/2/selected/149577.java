...
public class Resources extends Object {
    ...
    public static Reader getResourceAsReaderByFile(String resource, String encode) throws IOException {
        Reader reader;
        if (charset == null) {
            reader = new InputStreamReader(new FileInputStream(new File(resource)), encode);
        } else {
            reader = new InputStreamReader(getResourceAsStream(resource), charset);
        }
        return reader;
