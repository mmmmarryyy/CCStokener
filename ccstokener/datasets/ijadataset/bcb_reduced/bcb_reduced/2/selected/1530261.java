 ...
 * @version $Id: XmlStreamReader.java 1021884 2010-10-12 18:49:16Z ggregory $
...
public class XmlStreamReader extends Reader {
     ...
     * @throws IOException thrown if there is a problem reading the stream.
     */
    private String doRawStream(InputStream is, boolean lenient) throws IOException {
     ...
     * @throws IOException thrown if there is a problem reading the stream.
     */
    private String doLenientDetection(String httpContentType, InputStream is, XmlStreamReaderException ex) throws IOException {
