 ...
 * @author  Siddarth1
 */
public class NewGeographicSubDivisionAF extends javax.swing.JInternalFrame {

    /** Creates new form NewGenInternalFrame */
    private NewGeographicSubDivisionAF() {
        initComponents();
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
    }

    public static NewGeographicSubDivisionAF getInstance() {
        if (thisScreen == null) {
            thisScreen = new NewGeographicSubDivisionAF();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("NewGeographicSubDivision"));
    ...
    private static NewGeographicSubDivisionAF thisScreen;
}
