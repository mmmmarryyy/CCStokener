 ...
 *
 * @author	BitWise
 * @version	$Id: CatalogManager.java 492 2011-03-20 17:58:55Z andrew_jacobs $
 * @since	TFP 1.0
 */
public final class CatalogManager {
	 ...
	 * @since	TFP 1.0
	 */
    public static Catalog find(final String url) throws SAXException {
	 ...
	 * @since	TFP 1.0
	 */
    private static Logger logger = Logger.getLogger("com.handcoded.xml.resolver.CatalogManager");

    /**
	 * The set of previously processed catalogs indexed by filename.
	 * @since	TFP 1.0
	 */
    private static Hashtable<String, Catalog> catalogs = new Hashtable<String, Catalog>();
    ...
    private static class CatalogHandler extends DefaultHandler {
        ...
        public void startElement(String namespace, String localName, String QName, Attributes attributes) throws SAXException {
            if (localName.equals("catalog")) {
                ...
                } else throw new SAXException("Unexpected element tag in XML catalog file");
            }
        }

        public void endElement(String ns, String localName, String qName) throws SAXException {
            if (localName.equals("catalog") || localName.equals("group")) stack.pop();
        }
