...
public class DownloadingDataSet implements IDataSet {
    ...
    public Iterator<Node> getNodesByName(final String aLookFor) {
        return getFromURL(Settings.getInstance().get(XAPIBASEURSETTING, DEFAULTXAPIBASEURL) + "/node[name|ref|name:de|short_name:de=" + URLEncoder.encode(aLookFor) + "]").getNodesByName(aLookFor);
    }
    ...
    public Iterator<Node> getNodesByTag(final String aKey, final String aValue) {
        return getFromURL(Settings.getInstance().get(XAPIBASEURSETTING, DEFAULTXAPIBASEURL) + "/nodes[" + URLEncoder.encode(aKey) + "=" + URLEncoder.encode(aValue) + "]").getNodesByTag(aKey, aValue);
    }
    ...
    public Iterator<Way> getWaysByName(final String aLookFor, final Bounds aBoundingBox) {
        return getFromURL(Settings.getInstance().get(XAPIBASEURSETTING, DEFAULTXAPIBASEURL) + "/relation[name|ref|name:de|short_name:de=" + URLEncoder.encode(aLookFor) + "]").getWaysByName(aLookFor, aBoundingBox);
    }
    ...
    public Iterator<Way> getWaysByTag(final String aKey, final String aValue) {
        return getFromURL(Settings.getInstance().get(XAPIBASEURSETTING, DEFAULTXAPIBASEURL) + "/relation[" + URLEncoder.encode(aKey) + "=" + URLEncoder.encode(aValue) + "]").getWaysByTag(aKey, aValue);
    }
