...
class SmafFileReader {
    ...
    /** */
    public SmafFileFormat getSmafFileFormat(InputStream stream) throws InvalidSmafDataException, IOException {
        return SmafFileFormat.readFrom(stream);
    }

    /** */
    public SmafFileFormat getSmafFileFormat(File file) throws InvalidSmafDataException, IOException {
    ...
    /** */
    public Sequence getSequence(InputStream is) throws InvalidSmafDataException, IOException {
        SmafFileFormat ff = SmafFileFormat.readFrom(is);
        return ff.getSequence();
    }

    /** */
    public Sequence getSequence(File file) throws InvalidSmafDataException, IOException {
        InputStream is = new BufferedInputStream(new FileInputStream(file));
