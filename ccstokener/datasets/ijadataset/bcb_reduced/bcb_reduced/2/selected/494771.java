...
public class GUHelper {
    ...
    public enum TESTEVENT {
        ...
        EVENT_ETA("E_UPT_TIME", ID), EVENT_TRACK("E_UPT_TRACK", ID), EVENT_ROUTE_MODIFIED("E_UPT_ROUTE", ID), EVENT_ROUTE_CANCELED("E_UPT_ROUTE", ID_CANCELED), EVENT_RTI("P_UPT_RTI", ID_RTI), EVENT_RTP("P_UPT_RTP", ID_RTP);
