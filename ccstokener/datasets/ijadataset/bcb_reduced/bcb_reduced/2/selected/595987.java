...
public class BBSPostAction implements IPostAction {
    ...
    public class ExFileBody extends FileBody {
        ...
        public String getFilename() {
            if (filename == null) return super.getFilename(); else return filename;
        }
        ...
        private String getImageFileType(String mimeType) {
            if ("image/jpeg".equals(mimeType)) return ".jpg"; else if ("image/gif".equals(mimeType)) return ".gif"; else if ("image/png".equals(mimeType)) return ".png"; else if ("application/x-bmp".equals(mimeType)) return ".bmp"; else return "";
        }
    }
}
