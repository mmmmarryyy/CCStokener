            ...
            while (nbp > 0 && indice < nbLignes) {
                ...
                if (mon_token.hasMoreTokens()) {
                    while (nbp > 0 && mon_token.hasMoreTokens() == true) {
                        ...
                        My_ZoneVisu.tableau_points[indicetableau] = Double.valueOf(Un_Nombre.substring(0, Un_Nombre.indexOf(','))).doubleValue();
                        indicetableau++;
                        if (Un_Nombre.indexOf(',') == Un_Nombre.length() - 1) My_ZoneVisu.tableau_points[indicetableau] = Double.valueOf(mon_token.nextToken()).doubleValue(); else My_ZoneVisu.tableau_points[indicetableau] = Double.valueOf(Un_Nombre.substring(Un_Nombre.indexOf(',') + 1)).doubleValue();
                        indicetableau++;
                    }
                }
            }
