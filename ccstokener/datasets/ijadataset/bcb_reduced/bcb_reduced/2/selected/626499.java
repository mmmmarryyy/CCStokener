...
public final class IoUtility {
     ...
     */
    public static String loadFile(final String filename, final String encoding) throws IOException {
     ...
     * @throws  IOException File exception occurred.
     */
    public static void loadFile(final String filename, final StringBuffer buffer, final String encoding) throws IOException {
     ...
     */
    public static void loadStream(final InputStream in, final StringBuffer buffer) throws IOException {
        buffer.setLength(0);
        int c;
        while ((c = in.read()) >= 0) {
     ...
     * @throws  IOException File exception occurred.
     */
    public static void loadFile(final File file, final StringBuffer buffer, final String encoding) throws IOException {
     ...
     * @throws  IOException File exception occurred.
     */
    public static void saveFile(final File file, final StringBuffer text, final String encoding) throws IOException {
     ...
     */
    public static void copy(final String sourceLocation, final String targetLocation) throws IOException {
     ...
     * @throws  IOException     Something went wrong.
     */
    public static List listFilesRecursively(final File sourceLocation, final FileFilter filter) throws IOException {
     ...
     * @throws  IOException     Something went wrong.
     */
    private static List listFilesRecursivelyIntern(final File sourceLocation, final FileFilter filter) throws IOException {
        final List result = new ArrayList();
     ...
     * @throws  IOException File exception occurred.
     */
    public static boolean compareFilesBinary(final File from, final File with) throws IOException {
     ...
     */
    public static boolean compareTextFiles(final File from, final File with, final String encoding) throws IOException {
        if (from == null && with == null) {
            return true;
        }
        if (from == null || with == null) {
     ...
     * @throws  NullPointerException    Is encoding different from <code>null</code>?
     */
    public static boolean compareTextFiles(final File from, final File with, final int startAtLine, final String encoding) throws IOException {
        if (from == null && with == null) {
            return true;
        }
        if (from == null || with == null) {
