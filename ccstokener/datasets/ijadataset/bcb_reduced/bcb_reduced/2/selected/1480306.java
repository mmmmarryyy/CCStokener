...
public class EnterpriseWebModularTest extends AbstractTest {
    ...
    protected String[] getTestBundlesNames() {
        ...
        col.add("com.manning.sdmia.ch06, directory-modular-dao, 1.0.0");
        col.add("com.manning.sdmia.ch06, directory-modular-dao-jdbc, 1.0.0");
        col.add("com.manning.sdmia.ch06, directory-service, 1.0.0");
        col.add("com.manning.sdmia.ch06, directory-modular-service-impl, 1.0.0");
    ...
    protected String[] getConfigLocations() {
        return new String[] { "/com/manning/sdmia/ch06/directory/web/DirectoryWebModularTest-context.xml" };
    }
