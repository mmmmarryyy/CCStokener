...
public class ListRecords {
    ...
    /** Creates a new instance of ListRecords */
    public ListRecords() {
    }
    ...
    public String validateDate(String date) throws Exception {
        ...
        return c1.get(c1.YEAR) + "-" + (c1.get(c1.MONTH)) + "-" + c1.get(c1.DATE);
    }
}
