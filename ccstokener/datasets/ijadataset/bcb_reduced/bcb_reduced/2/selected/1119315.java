 ...
 */
public class NewGeographicNameAFSHInternalFrame extends javax.swing.JInternalFrame {

    /** Creates new form NewGeographicNameAFSHInternalFrame */
    public NewGeographicNameAFSHInternalFrame() {
        initComponents();
        ...
        this.geonamepanel = new newgen.presentation.administration.GeographicNameAFSH();
        this.addPanel.add(this.geonamepanel);
        this.geonamepanel.setFromSearch();
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
    }

    public static NewGeographicNameAFSHInternalFrame getInstance() {
        if (thisScreen == null) {
            thisScreen = new NewGeographicNameAFSHInternalFrame();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(newgen.presentation.NewGenMain.getAppletInstance().getMyResource().getString("NewGeographicNameSubjectHeading"));
    ...
    private static NewGeographicNameAFSHInternalFrame thisScreen;

    private newgen.presentation.administration.GeographicNameAFSH geonamepanel;
}
