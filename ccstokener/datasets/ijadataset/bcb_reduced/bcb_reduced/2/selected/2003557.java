...
public class TestStatefulConnManagement extends ServerTestBase {
    ...
    public void testStatefulConnections() throws Exception {
        ...
        ConnManagerParams.setMaxConnectionsPerRoute(params, new ConnPerRouteBean(workerCount));
    ...
    static class HttpWorker extends Thread {
        ...
        public HttpWorker(final HttpContext context, int requestCount, final HttpHost target, final HttpClient httpclient) {
            super();
