...
public class HtmlUtil {
	 ...
	 * @return
	 */
    public static boolean saveUrltoFile(String urlPath, String filePath, String encoding) {
        FileUtil.createFile(filePath, getUrlString(urlPath, encoding), encoding);
        return true;
    }
    ...
    public static void main(String args[]) {
        System.out.println(HtmlUtil.getUrlString("http://www.hao123.com", "gb2312"));
    }
}
