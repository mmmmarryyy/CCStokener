...
public class HUDFont {
    ...
    public static enum FontStyle {
        ...
        PLAIN(java.awt.Font.PLAIN), BOLD(java.awt.Font.BOLD), ITALIC(java.awt.Font.ITALIC), BOLD_ITALIC(java.awt.Font.BOLD | java.awt.Font.ITALIC);
        ...
        public final FontStyle makeItalic() {
            if (this == PLAIN) return (ITALIC);
            if (this == BOLD) return (BOLD_ITALIC);
            return (this);
        }

        public final FontStyle makeNonItalic() {
            if (this == ITALIC) return (PLAIN);
            if (this == BOLD_ITALIC) return (BOLD);
            return (this);
        }

        public final FontStyle makeBold() {
            if (this == PLAIN) return (BOLD);
            if (this == BOLD) return (BOLD_ITALIC);
            return (this);
        }

        public final FontStyle makeNonBold() {
            if (this == BOLD) return (PLAIN);
            if (this == BOLD_ITALIC) return (ITALIC);
            return (this);
        }
