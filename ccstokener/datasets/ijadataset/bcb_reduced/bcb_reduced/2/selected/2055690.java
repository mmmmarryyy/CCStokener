...
public class CacheUtil {
    ...
    public static <I> I getInstanceByInterface(Class<I> interfaceDefinition, ClassLoader classLoader, String defaultImplClass, boolean needCache) {
        ...
        if (needCache) {
            ...
            if (className != null && !className.equals("")) return newInstance(interfaceDefinition, className, classLoader);
        } else {
        ...
        try {
            ...
            if (systemProp != null) {
                ...
                if (needCache) localCache.put(interfaceDefinition.getName(), systemProp);
        ...
        InputStream in = null;
        try {
            if (classLoader == null) in = ClassLoader.getSystemResourceAsStream(serviceId); else in = classLoader.getResourceAsStream(serviceId);
            if (in != null) {
                ...
                if (className != null && !"".equals(className)) {
                    ...
                    if (needCache) localCache.put(interfaceDefinition.getName(), className);
                ...
                if (defaultImplClass != null && !defaultImplClass.equals("")) {
                    ...
                    if (needCache) localCache.put(interfaceDefinition.getName(), defaultImplClass);
        ...
        if (result == null) throw new java.lang.RuntimeException(errorStr);
        return result;
    }
