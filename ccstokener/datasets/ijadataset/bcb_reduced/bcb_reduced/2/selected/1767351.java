 ...
 */
public class SearchGeneralSubDivisionAF extends javax.swing.JPanel implements javax.swing.event.CaretListener {

    /** Creates new form SearchPersonalNameAF */
    public SearchGeneralSubDivisionAF() {
        initComponents();
        String[] col = { java.util.ResourceBundle.getBundle("Administration").getString("GeneralSubDivision") };
    ...
    private void bnewActionPerformed(java.awt.event.ActionEvent evt) {
        newgen.presentation.administration.NewGeneralSubDivisionAFDialog npafd = new newgen.presentation.administration.NewGeneralSubDivisionAFDialog();
    ...
    public Object[] getSelectedValuesWithKey() {
        ...
        if (selectedrow == -1) {
            ...
            retobj[0] = this.dtmSearch.getValueAt(selectedrow, 0).toString();
            retobj[1] = ((String[]) this.gensdid_libid.get(selectedrow))[0];
            retobj[2] = ((String[]) this.gensdid_libid.get(selectedrow))[1];
        }
        return retobj;
    }
    ...
    private java.util.ArrayList gensdid_libid = new java.util.ArrayList();
