...
public final class ApplTools {
     ...
     */
    public static void aboutApplication(Object frame, String title, Version version, String licence, String homePage, String date, String ide, String iconLicence, String libraryLicence, Icon logo, JButton okButton, LanguageManager lm) {
        ...
        String[] msg = { "<html>", "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"  style=\"font-weight:bold;\">", "<tr><td>", lm.getText("Application"), "</td><td>: ", title, _NEW_LINE_, lm.getText("Version"), "</td><td>: ", version.toString(), _NEW_LINE_, lm.getText("Copyright") + "&nbsp;", "</td><td>: ", "© " + copyrightYear + " PPonec", _NEW_LINE_, lm.getText("License"), "</td><td>: ", licence, _NEW_LINE_, lm.getText("Home"), "</td><td>: ", homePage, _NEW_LINE_, lm.getText("Finished"), "</td><td>: ", date, _NEW_LINE_, lm.getText("Library"), "</td><td>: ", libraryLicence, "</td></tr>", _NEW_LINE_, lm.getText("Icons"), "</td><td>: ", iconLicence, _NEW_LINE_, lm.getText("Java"), "</td><td>: ", System.getProperty("java.version"), " - ", System.getProperty("java.vendor"), _NEW_LINE_, lm.getText("IDE"), "</td><td>: ", ide, _NEW_LINE_, lm.getText("TranslatedBy"), "</td><td>: ", lm.getText("TranslatedBy.YOUR_NAME"), "</td></tr>", "</table></html>" };
        javax.swing.JOptionPane.showOptionDialog(frame instanceof Component ? (Component) frame : null, stringCat("", msg), lm.getText("About"), javax.swing.JOptionPane.OK_OPTION, javax.swing.JOptionPane.INFORMATION_MESSAGE, logo, new JButton[] { okButton }, okButton);
    }
    ...
    @SuppressWarnings("unchecked")
    public static final <T> Class<T> getClass(String className, File jar) throws MalformedURLException, ClassNotFoundException {
