...
public class SolrUpdate {
    ...
    public static void main(String[] args) {
        ...
        try {
            if (verbose) System.out.println("Connecting to solr server at URL: " + solrServerURL); else logger.info("Connecting to solr server at URL: " + solrServerURL);
            signalServer(solrServerURL);
        } catch (MalformedURLException me) {
            if (verbose) System.out.println("Specified URL is malformed: " + solrServerURL); else logger.error("Specified URL is malformed: " + solrServerURL);
        } catch (IOException ioe) {
            if (verbose) System.out.println("Unable to establish connection to solr server at URL: " + solrServerURL); else logger.error("Unable to establish connection to solr server at URL: " + solrServerURL);
        }
    }
