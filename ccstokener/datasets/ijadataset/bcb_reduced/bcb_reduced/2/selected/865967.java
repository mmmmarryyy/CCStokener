...
public class Utils implements Constants {
	 ...
	 * @return
	 */
    public static String stringMinutes2stringXMLDuration(String minutes) throws DatatypeConfigurationException {
    ...
    public static Duration stringXML2Duration(String lexicalRepresentation) throws DatatypeConfigurationException {
    ...
    public static String element2String(Element elem, boolean formatted) {
        ...
        if (formatted) return format.outputString(elem); else return compact.outputString(elem);
    }

    public static String attribute2String(Attribute a) {
        if (a == null) return null; else return a.getName() + "=" + a.getValue();
    }
