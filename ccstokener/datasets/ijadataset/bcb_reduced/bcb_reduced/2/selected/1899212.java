package org.kidsd.dspace.mediaplayer.servlet;
...
/**
 * Servlet for handle streaming video viewing (MP4)
 * 
 * @author krissada
 * 
 */
public class ViewVideoServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 8802658968101598497L;

    private static final String PLAYBACK_TEMPLATE_FILENAME = "videotemplate";

    private static final String PLAYBACK_TEMPLATE_FILE_EXTENSION = ".txt";

    /** log4j logger */
    private static Logger log = Logger.getLogger(ViewVideoServlet.class);
