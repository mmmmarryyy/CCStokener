    ...
    */
    ...
    private JMenuBar getMenu() {
        if (null == menu) {
            ...
            menuItem.addActionListener(actionListener);
            menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, mask));
    ...
    public void doImportFood() {
        ...
        if (fd.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            if (foods != null) {
                ...
                JOptionPane.showMessageDialog(this, foods.length + " food(s) have been added to your foods.", "Food(s) Added", JOptionPane.INFORMATION_MESSAGE);
                refreshDisplays();
            }
        }
    }
