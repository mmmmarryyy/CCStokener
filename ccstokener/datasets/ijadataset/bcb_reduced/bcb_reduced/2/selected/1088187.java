...
public class IOLib {
    ...
    public static URL urlFromString(String location, Class referrer, boolean includeFileSystem) {
        ...
        if (isUrlString(location)) {
            ...
            if (referrer != null) url = referrer.getResource(location); else url = IOLib.class.getResource(location);
            if (url == null && !location.startsWith("/")) url = IOLib.class.getResource("/" + location);
