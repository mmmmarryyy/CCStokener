...
public class ResourceModule extends AbstractModule {
    ...
    private static final Logger log = LoggerFactory.getLogger(ResourceModule.class);
    ...
    public void addComponentsFromProperties(Properties props, ClassLoader classLoader) {
        ...
        if (log.isDebugEnabled()) log.debug("addComponentsFromProperties() : " + props.size() + " properties.");
        while (keyNames.hasMoreElements()) {
            ...
            if (Module.class.isAssignableFrom(impl)) {
                ...
                if (log.isDebugEnabled()) log.debug("addComponentsFromProperties() : ignoring [" + keyName + "=" + valueName + "]");
            }
        }
    }
}
