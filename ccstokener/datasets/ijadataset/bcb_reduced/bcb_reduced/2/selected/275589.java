...
public class ServletContextImpl implements ServletContext {
    ...
    public Set<String> getResourcePaths(String path) {
        ...
        for (URL base : docBase) {
            ...
            File targetResource = new File(PathUtil.jointPathWithSlash(baseFile.getAbsolutePath(), path));
    ...
    public Enumeration<Servlet> getServlets() {
        if (servletMap == null) return new IteratorEnumeration<Servlet>();
        ...
        if (url.getProtocol().startsWith("file")) {
            try {
                ...
                if (file.exists()) {
                    ...
                    String testResource = PathUtil.replaceFileSeparator(resource);
                    if (testPath.endsWith("/") == false && testResource.endsWith("/") == true) {
    ...
    public Enumeration<String> getAttributeNames() {
        return new IteratorEnumeration<String>(attributeMap.keySet().iterator(), true);
    }
    ...
    public RequestDispatcher getRequestDispatcher(String requestPath) {
        ...
        InternalWebApplication webapp = webApp.getWebApplicationManager().findWebApp(this.servletContextName);
