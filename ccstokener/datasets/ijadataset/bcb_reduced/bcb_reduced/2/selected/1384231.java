...
public class jdbcConnection implements Connection {
    ...
    private static final int HTTP = 0, STANDALONE = 1, INTERNAL = 2, HSQL = 3;
    ...
    private void reconnectHSQL() throws SQLException {
        try {
            ...
            dOutput = new DataOutputStream(new BufferedOutputStream(sSocket.getOutputStream()));
            dInput = new DataInputStream(new BufferedInputStream(sSocket.getInputStream()));
