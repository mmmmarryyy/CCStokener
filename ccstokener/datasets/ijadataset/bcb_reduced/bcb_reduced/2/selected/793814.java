...
public class RepeatableInputStream extends InputStream implements Repeatable {
    ...
    public static InputStream getInstance(InputStream is) {
        if (is instanceof ByteArrayInputStream) return new ResetableInputStream(is); else if (is != null && !(is instanceof Repeatable)) return new RepeatableInputStream(is);
        return is;
    }
    ...
    private OutputStream getOutputStream() throws IOException {
        if (_out == null) return _nobuf ? null : (_out = new ByteArrayOutputStream());
        if (_cntsz >= _bufmaxsz) {
            disableBuffering();
            return null;
        }
        if (_f == null && _cntsz >= _memmaxsz) {
            try {
                final File f = new File(System.getProperty("java.io.tmpdir"), "zk");
    ...
    public int read() throws IOException {
        if (_org != null) {
            ...
            if (_in == null) _in = new BufferedInputStream(new FileInputStream(_f));
            return _in.read();
        }
    }
    ...
    public void close() throws IOException {
        ...
        if (_org != null) {
            ...
            if (_out != null) {
                ...
                if (_f == null) _in = new ByteArrayInputStream(((ByteArrayOutputStream) _out).toByteArray());
                _out = null;
                _org = null;
            }
        } else if (_in != null) {
...
class RepeatableFileInputStream extends InputStream implements Repeatable {
    ...
    public int read() throws IOException {
        if (_in == null) _in = new BufferedInputStream(new FileInputStream(_file));
        return _in.read();
    }
