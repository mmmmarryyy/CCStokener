...
public class MetadataFactoryRegistry {
    ...
    private static final Map<Class, Object> table;
    ...
    static {
        ...
        if (configurationFileLoc == null) {
            if (log.isDebugEnabled()) {
                log.debug("A configuration file location was not set. The " + "following location will be used: " + Constants.METADATA_REGISTRY_CONFIG_FILE);
            }
