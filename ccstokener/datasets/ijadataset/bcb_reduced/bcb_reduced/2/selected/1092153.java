...
public class TextControlWidget extends javax.swing.JPanel {
    ...
    public TextControlWidget(TextControl aTextControl) throws RemoteException, VisADException {
        ...
        String[] sizes = { "8", "9", "10", "11", "12", "14", "16", "18", "24", "36", "48", "72" };
   ...
   */
    ...
    private void vertJustificationJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void autoSizeJCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void labelFontJRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void offsetZFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void offsetYFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void offsetXFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void javaFontJRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {
        fontNamesJList.setListData(javaFontNames);
        fontNamesJList.setSelectedIndex(0);
    ...
    private void textToPreviewFieldActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void scaleTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void characterRotationFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void horizJustificationJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void textOrientationFieldActionPerformed(java.awt.event.ActionEvent evt) {
        updateTextControl();
    }

    private void fontSizesJListValueChanged(javax.swing.event.ListSelectionEvent evt) {
        updateTextControl();
    }

    private void fontStylesJListValueChanged(javax.swing.event.ListSelectionEvent evt) {
        updateTextControl();
    }

    private void fontNamesJListValueChanged(javax.swing.event.ListSelectionEvent evt) {
        updateTextControl();
    }

    private void hersheyFontjRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private Object getSelectedFont() {
        ...
        if (javaFontJRadioButton.isSelected()) {
            ...
            return new Font((String) fontNamesJList.getSelectedValue(), fontStylesJList.getSelectedIndex(), size);
    ...
    */
    ...
    private void setupPreviewDisplay() throws RemoteException, VisADException {
        ...
        Linear2DSet domain = new Linear2DSet(coord_tuple_type, -120.0, 120.0, 1, -120.0, 120.0, 1);
