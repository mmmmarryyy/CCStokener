...
public class MetaBuilder {
    ...
    static {
        String packagePrefixes = System.getProperty("groovy.sanitized.stacktraces", "groovy.," + "org.codehaus.groovy.," + "java.," + "javax.," + "sun.," + "gjdk.groovy.,");
        try {
            System.setProperty("groovy.sanitized.stacktraces", packagePrefixes + "groovytools.builder.,");
        } catch (Exception exc) {
        }
    }
    ...
    protected SchemaNode createDefaultMetaSchema() {
        ...
        SchemaNode colSchema = new SchemaNode(colsSchema, "%");
        ...
        SchemaNode colElementSchema = new SchemaNode(colSchema, "%");
