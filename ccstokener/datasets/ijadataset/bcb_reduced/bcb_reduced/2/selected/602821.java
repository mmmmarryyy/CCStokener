...
public class ConverterUtil {
    ...
    public static final Pattern YES_PATTERN = Pattern.compile("(yes|true|y|1)", Pattern.CASE_INSENSITIVE);

    private static Map<Class<?>, Converter<?>> map = new HashMap<Class<?>, Converter<?>>(19);
    ...
    public abstract static class DateConverter implements Converter<java.util.Date> {
