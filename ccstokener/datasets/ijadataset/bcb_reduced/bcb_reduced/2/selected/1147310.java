...
public class ModelLoader {
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                if (isValidModelFile(file)) {
                    ...
                    try {
                        ...
                        logger.logp(Level.SEVERE, ModelLoader.class.toString(), "main(args)", "Exception", exc);
                    }
                    game.start();
                        ...
                        if (file.getName().toLowerCase().endsWith(".jme")) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    logger.logp(Level.SEVERE, ModelLoader.class.toString(), "main(args)", "Exception", exc2);
                                }
    ...
    static {
        ...
        try {
            ...
            logger.logp(Level.SEVERE, ModelLoader.class.toString(), "<static>", "InstantiationException", ex);
        }
    }
    ...
    static class ModelLoaderCallable implements Callable<Node> {
        ...
        public ModelLoaderCallable(FormatConverter conv) {
            this(conv, null);
        }
        ...
        protected URL getURL() {
            return ResourceLocatorTool.locateResource(ResourceLocatorTool.TYPE_MODEL, file);
        }
