...
public final class SitoolsEngine {
   ...
   */
    ...
    /**
   * Registered AbstractSva list
   */
    private final List<fr.cnes.sitools.dataset.sva.business.AbstractSva> datasetSvas;
   ...
   */
    public SitoolsEngine(boolean discoverHelpers) {
        ...
        datasetSvas = new CopyOnWriteArrayList<fr.cnes.sitools.dataset.sva.business.AbstractSva>();
   ...
   */
    ...
    /**
   * Discovers of the svas available to the user
   * 
   * @throws IOException
   *           when filter folder not found
   */
    private void discoverDatasetSvas() throws IOException {
        registerHelpers(DESCRIPTOR_DATASET_SVA_PATH, getDatasetSvas(), null);
    }
   ...
   */
    ...
    /**
   * Returns the list of available svas.
   * 
   * @return The list of available svas.
   */
    public List<fr.cnes.sitools.dataset.sva.business.AbstractSva> getDatasetSvas() {
        return datasetSvas;
    }
   ...
   */
    public void setDatasetConverters(List<fr.cnes.sitools.dataset.converter.business.AbstractConverter> registeredConverters) {
   ...
   * @param registeredParameterizedResources the registeredParameterizedResources to set
   */
