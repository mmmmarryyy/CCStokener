...
public class TrainDialog extends JDialog {
    ...
    private JPanel buildTrainPanel() {
        ...
        btAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String arrive = "00:00";
                String leave = "00:00";
                ((TrainTableModel) table.getModel()).myTrain.insertStop(new Stop(name, arrive, leave, false), table.getSelectedRow());
                table.revalidate();
            }
        });
    ...
    private void doSetColor(final Train train) {
        ...
        JDialog dialog = JColorChooser.createDialog(mainFrame, _("Select the color for the line"), true, colorChooser, listener, null);
        ETRC.setFont(dialog);
