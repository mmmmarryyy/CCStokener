    ...
    public void refreshAttributes() {
        try {
            ...
            while (true) {
                ...
                if (log.isDebugEnabled()) log.debug("name: " + name + " att=" + att + " val=" + val);
            ...
            while (true) {
                ...
                if (line == null || line.startsWith("[")) {
                    if (name != null) {
                        ...
                        if (log.isDebugEnabled()) log.debug("mbean name: " + name + " type=" + type);
                        getters.clear();
                        setters.clear();
                        methods.clear();
                    }
    ...
    static class MBeanProxy extends BaseModelMBean {
        ...
        void init(String name, List getters, List setters, List methods) throws Exception {
            ...
            for (int i = 0; i < getters.size(); i++) {
                ...
                ai.setName(att);
                ai.setType("java.lang.String");
                if (!setters.contains(att)) ai.setWriteable(false);
                mbean.addAttribute(ai);
            }
        ...
        public void setAttribute(Attribute attribute) throws AttributeNotFoundException, MBeanException, ReflectionException {
            try {
                ...
                if (log.isDebugEnabled()) log.debug("Setting " + jkName + " " + name + " result " + res);
        ...
        public Object invoke(String name, Object params[], String signature[]) throws MBeanException, ReflectionException {
            try {
                ...
                String res = is.readLine();
                if (log.isDebugEnabled()) log.debug("Invoking " + jkName + " " + name + " result " + res);
                jkmx.refreshMetadata();
                jkmx.refreshAttributes();
            } catch (Exception ex) {
                throw new MBeanException(ex);
