...
public class JETCompiler implements JETParseEventListener {
   ...
   */
            ...
            if (fileURI != null) {
                ...
                try {
                    ...
                    if ("alternative".equals(failType)) {
                        ...
                        throw new JETException(CodeGenPlugin.getPlugin().getString("jet.error.file.cannot.read", new Object[] { resolvedFileURI[1], start.format("jet.mark.file.line.column") }), exception);
                    }
                }
            } else {
    ...
    public void endPageProcessing() throws JETException {
        if (sectionDepth > 0) {
            throw new JETException(CodeGenPlugin.getPlugin().getString("jet.error.unmatched.directive", new Object[] { "end", "start", reader.mark().format("jet.mark.file.line.column") }));
        }
        if (skeleton == null) {
            throw new JETException(CodeGenPlugin.getPlugin().getString("jet.error.missing.jet.directive", new Object[] { reader.mark().format("jet.mark.file.line.column") }));
        }
        if (fSavedLine != null) {
            addCharDataGenerator(fSavedLine);
        }
    ...
    public void parse() throws JETException {
        ...
        JETCoreElement[] coreElements = { directive, new JETParser.QuoteEscape(), new JETParser.Expression(), new JETParser.Scriptlet() };
