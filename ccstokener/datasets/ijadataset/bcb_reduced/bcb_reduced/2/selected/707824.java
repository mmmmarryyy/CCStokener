 ...
 */
public class SearchGeographicalSubDivisionAF extends javax.swing.JPanel implements javax.swing.event.CaretListener {

    /** Creates new form SearchPersonalNameAF */
    public SearchGeographicalSubDivisionAF() {
        initComponents();
        String[] col = { java.util.ResourceBundle.getBundle("Administration").getString("GeographicalSubDivision") };
    ...
    private void bnewActionPerformed(java.awt.event.ActionEvent evt) {
        newgen.presentation.administration.NewGeographicalSubDivisionAFDialog npafd = new newgen.presentation.administration.NewGeographicalSubDivisionAFDialog();
    ...
    public Object[] getSelectedValuesWithKey() {
        ...
        if (selectedrow == -1) {
            ...
            retobj[0] = this.dtmSearch.getValueAt(selectedrow, 0).toString();
            retobj[1] = ((String[]) this.geoid_libid.get(selectedrow))[0];
            retobj[2] = ((String[]) this.geoid_libid.get(selectedrow))[1];
        }
        return retobj;
    }
    ...
    private java.util.ArrayList geoid_libid = new java.util.ArrayList();
