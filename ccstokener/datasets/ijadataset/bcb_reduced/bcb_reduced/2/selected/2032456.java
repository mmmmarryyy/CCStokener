...
public class ResourceManager {
   ...
   */
    public static void disposeColors() {
        for (Iterator<Color> iter = m_ColorMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
        m_ColorMap.clear();
    }
   ...
   */
    public static void disposeCursors() {
        for (Iterator<Cursor> iter = m_IdToCursorMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
   ...
   */
    public static void disposeFonts() {
        for (Iterator<Font> iter = m_FontMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
        m_FontMap.clear();
        for (Iterator<Font> iter = m_FontToBoldFontMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
        m_FontToBoldFontMap.clear();
        for (Iterator<Font> iter = m_FontToItalicFontMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
   ...
   */
    public static void disposeImages() {
        for (Iterator<Image> iter = m_ClassImageMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
        m_ClassImageMap.clear();
        for (Iterator<Image> iter = m_DescriptorImageMap.values().iterator(); iter.hasNext(); ) iter.next().dispose();
   ...
   */
    ...
    private static URL getPluginImageURL(Object plugin, String name) throws Exception {
        ...
        Method getDescriptorMethod = pluginClass.getMethod("getDescriptor", (Class[]) null);
        Class pluginDescriptorClass = Class.forName("org.eclipse.core.runtime.IPluginDescriptor");
        Method getInstallURLMethod = pluginDescriptorClass.getMethod("getInstallURL", (Class[]) null);
