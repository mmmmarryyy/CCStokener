...
public class XmlRpcClient extends XmlRpcParser implements XmlRpcInvocationHandler {
     ...
     * @throws  
     */
    public synchronized Object invoke(String method, List arguments) throws XmlRpcException, XmlRpcFault, TimeoutException, InterruptedException {
        beginCall(method);
        if (arguments != null) {
     ...
     *                          that can. There may also be problems with the socket communication.
     */
    public synchronized Object invoke(String method, Object[] arguments) throws XmlRpcException, XmlRpcFault, TimeoutException, InterruptedException {
        beginCall(method);
        if (arguments != null) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        callback.onException(new XmlRpcException(""));
                    } catch (TimeoutException ex) {
                        callback.onException(new XmlRpcException(""));
                    } catch (XmlRpcException e) {
     ...
     */
    private void beginCall(String methodName) throws XmlRpcException, TimeoutException, InterruptedException {
        try {
            if (streamMessages) {
                openConnection();
                writer = new BufferedWriter(new OutputStreamWriter(Timeouts.getOutputStream(connection), XmlRpcMessages.getString("XmlRpcClient.Encoding")));
            } else {
     ...
     */
    private Object endCall() throws XmlRpcException, XmlRpcFault, TimeoutException, InterruptedException {
        try {
            writer.write("</params>");
            ...
            if (streamMessages) {
                ...
                OutputStream output = new BufferedOutputStream(Timeouts.getOutputStream(connection));
    ...
    private void handleResponse() throws XmlRpcFault {
        try {
            parse(new BufferedInputStream(Timeouts.getInputStream(connection)));
        } catch (Exception e) {
