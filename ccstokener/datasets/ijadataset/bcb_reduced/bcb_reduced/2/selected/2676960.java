...
public abstract class GLSLShaderObjectsState extends RenderState {
    ...
    protected HashMap<String, ShaderVariable> shaderUniforms = new HashMap<String, ShaderVariable>();

    /** Storage for shader attribute values */
    protected HashMap<String, ShaderVariable> shaderAttributes = new HashMap<String, ShaderVariable>();
    ...
    public void setUniform(String name, boolean value) {
        ShaderVariableInt shaderUniform = getShaderUniform(name, ShaderVariableInt.class);
    ...
    public void setUniform(String name, float value) {
        ShaderVariableFloat shaderUniform = getShaderUniform(name, ShaderVariableFloat.class);
        shaderUniform.value1 = value;
        setNeedsRefresh(true);
    }
    ...
    public void setUniform(String name, boolean value1, boolean value2) {
        ShaderVariableInt2 shaderUniform = getShaderUniform(name, ShaderVariableInt2.class);
    ...
    public void setUniform(String name, float value1, float value2) {
        ShaderVariableFloat2 shaderUniform = getShaderUniform(name, ShaderVariableFloat2.class);
        shaderUniform.value1 = value1;
        shaderUniform.value2 = value2;
        setNeedsRefresh(true);
    }
    ...
    public void setUniform(String name, boolean value1, boolean value2, boolean value3) {
        ShaderVariableInt3 shaderUniform = getShaderUniform(name, ShaderVariableInt3.class);
        shaderUniform.value1 = value1 ? 1 : 0;
        shaderUniform.value2 = value2 ? 1 : 0;
    ...
    public void setUniform(String name, float value1, float value2, float value3) {
        ShaderVariableFloat3 shaderUniform = getShaderUniform(name, ShaderVariableFloat3.class);
        shaderUniform.value1 = value1;
        shaderUniform.value2 = value2;
        shaderUniform.value3 = value3;
        setNeedsRefresh(true);
    ...
    public void setUniform(String name, boolean value1, boolean value2, boolean value3, boolean value4) {
        ShaderVariableInt4 shaderUniform = getShaderUniform(name, ShaderVariableInt4.class);
        shaderUniform.value1 = value1 ? 1 : 0;
        shaderUniform.value2 = value2 ? 1 : 0;
        shaderUniform.value3 = value3 ? 1 : 0;
    ...
    public void setUniform(String name, float value1, float value2, float value3, float value4) {
        ShaderVariableFloat4 shaderUniform = getShaderUniform(name, ShaderVariableFloat4.class);
        shaderUniform.value1 = value1;
        shaderUniform.value2 = value2;
        shaderUniform.value3 = value3;
        shaderUniform.value4 = value4;
    ...
    public void setUniform(String name, float value[], boolean rowMajor) {
        ...
        ShaderVariableMatrix2 shaderUniform = getShaderUniform(name, ShaderVariableMatrix2.class);
    ...
    public void setUniform(String name, Matrix3f value, boolean rowMajor) {
        ShaderVariableMatrix3 shaderUniform = getShaderUniform(name, ShaderVariableMatrix3.class);
    ...
    public void setUniform(String name, Matrix4f value, boolean rowMajor) {
        ShaderVariableMatrix4 shaderUniform = getShaderUniform(name, ShaderVariableMatrix4.class);
        shaderUniform.matrixBuffer.rewind();
        value.fillFloatBuffer(shaderUniform.matrixBuffer);
        shaderUniform.matrixBuffer.rewind();
        shaderUniform.rowMajor = rowMajor;
    ...
    public void setUniform(String name, Matrix4f[] values, boolean rowMajor) {
        ShaderVariableMatrix4Array shaderUniform = getShaderUniform(name, ShaderVariableMatrix4Array.class);
     ...
     */
    public void setAttributePointer(String name, int size, boolean normalized, int stride, FloatBuffer data) {
        ShaderVariablePointerFloat shaderUniform = getShaderAttribute(name, ShaderVariablePointerFloat.class);
     ...
     * @param data The actual data to use as attribute pointer
     */
    public void setAttributePointer(String name, int size, boolean normalized, boolean unsigned, int stride, ByteBuffer data) {
        ShaderVariablePointerByte shaderUniform = getShaderAttribute(name, ShaderVariablePointerByte.class);
        shaderUniform.size = size;
        shaderUniform.normalized = normalized;
     ...
     * @param data The actual data to use as attribute pointer
     */
    public void setAttributePointer(String name, int size, boolean normalized, boolean unsigned, int stride, IntBuffer data) {
        ShaderVariablePointerInt shaderUniform = getShaderAttribute(name, ShaderVariablePointerInt.class);
        shaderUniform.size = size;
        shaderUniform.normalized = normalized;
        shaderUniform.unsigned = unsigned;
        shaderUniform.stride = stride;
     ...
     * @param data The actual data to use as attribute pointer
     */
    public void setAttributePointer(String name, int size, boolean normalized, boolean unsigned, int stride, ShortBuffer data) {
        ShaderVariablePointerShort shaderUniform = getShaderAttribute(name, ShaderVariablePointerShort.class);
        shaderUniform.size = size;
        shaderUniform.normalized = normalized;
        shaderUniform.unsigned = unsigned;
        shaderUniform.stride = stride;
    ...
    private <T extends ShaderVariable> T getShaderVariable(String name, Class<T> classz, HashMap<String, ShaderVariable> shaderVariableList) {
    ...
    public void read(JMEImporter e) throws IOException {
        ...
        shaderUniforms = (HashMap<String, ShaderVariable>) capsule.readStringSavableMap("shaderUniforms", new HashMap<String, ShaderVariable>());
        shaderAttributes = (HashMap<String, ShaderVariable>) capsule.readStringSavableMap("shaderAttributes", new HashMap<String, ShaderVariable>());
    }
     ...
     *java.net.URL)
     */
    protected abstract void sendToGL(ByteBuffer vertexByteBuffer, ByteBuffer fragmentByteBuffer);
