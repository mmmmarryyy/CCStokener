...
public final class IoUtility {
     ...
     * @throws  IOException File exception occurred.
     */
    public static void loadFile(final String filename, final StringBuffer buffer) throws IOException {
        ...
        try {
            ...
            try {
                ...
                while (0 <= (i = org.indexOf("/", j))) {
                    if (i >= 0 && nex.length() > i && org.substring(j, i).equals(nex.substring(j, i))) {
                        j = i + 1;
                    } else {
                        break;
                    }
    ...
    public static final File getStartDirectory(final String application) {
        ...
        if (isWebStarted()) {
            final String userHomeWS = System.getProperties().get("jnlpx.deployment.user.home") != null ? (String) System.getProperties().get("jnlpx.deployment.user.home") : "";
            final String userHome = System.getProperties().get("user.home") != null ? (String) System.getProperties().get("user.home") : "";
