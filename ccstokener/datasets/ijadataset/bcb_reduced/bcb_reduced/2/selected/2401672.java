...
public class GribTab implements Comparable {
    ...
    * @throws IOException
    */
    public GribTab(String fileName) throws IOException {
    ...
    */
    private String getPString(int id, int pos) {
        if (paramtable_opn == null || id < 0 || id > paramtable_opn.length) return null;
    ...
    */
    public void printTable() {
        String str = "PARAMETER TABLE: " + "\t center: " + center_id + "\t table: " + paramter_table + "\n\t resource: " + resource;
        System.out.println(str);
        if (paramtable_opn == null) {
            System.out.println("\t NO TABLE");
        } else {
            for (int id = 0; id < paramtable_opn.length; ++id) {
                str = "\t " + id + "\t " + paramtable_opn[id][0] + "\t ," + paramtable_opn[id][1] + "\t , [" + paramtable_opn[id][2] + "]";
                System.out.println(str);
            }
        }
        System.out.println();
