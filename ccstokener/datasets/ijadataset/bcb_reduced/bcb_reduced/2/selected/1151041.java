...
public final class Images {
     ...
     */
    public static Image imageFromFile(String path) throws FileNotFoundException, IOException, NotImageException {
     ...
     * @throws NotImageException if image is empty
     */
    public static GVector imageData(Image image, int x, int y, int width, int height) throws NotImageException {
        ensureImage(image);
