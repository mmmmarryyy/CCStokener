 ...
 */
public final class ApacheAgent extends AbstractAgent implements ApacheConstants {
	 ...
	 */
    final class ApacheExecutionContext extends ExecutionContext implements ApacheAgentExecutionContext {
    ...
    private void setupURL() throws MalformedURLException {
        ...
        String urls = "http://" + this.fConfiguration.getMonitoredHost() + ":" + conf.getInt(Configuration.PORT) + "/server-status";
