...
public class SpellChecker {
    ...
    public SpellResponse check(SpellRequest request) {
        try {
            ...
            requestStream.flush();
            requestStream.close();
            if (logger.isDebugEnabled()) logger.debug(new String(requestData));
            int c = 0;
            ...
            if (logger.isDebugEnabled()) logger.debug(buff);
    ...
    private String buildUri() {
        ...
        if (overHttps) uri.append("https://"); else uri.append("http://");
