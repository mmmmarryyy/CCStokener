...
public class PsiReportBuilder {
    ...
    public PsiReport createPsiReport() throws IOException {
        ...
        try {
            ...
            FacesMessage facesMessage = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Sorry, an unexpected error occur, please contact the " + "administrator of this web site if the issue persist.", t.getMessage());
     ...
     */
    private void validatePsiFile(PsiReport report, File file, InputStream ontologyCfg, InputStream cvMappingCfg, InputStream ruleCfg) {
        StringWriter sw = new StringWriter(1024);
