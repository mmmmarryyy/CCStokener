...
/**
 * Soll ein XML aus dem Internet ziehen 
 * (nach Authentifizierung �ber (?)) und es 
 * im Homeverzeichnis ablegen.
 * Vorher schauen, ob nicht schon vorhanden und aktuell etc...
 * 
 * @author philipp
 *
 */
public class ImportFromInternet {
