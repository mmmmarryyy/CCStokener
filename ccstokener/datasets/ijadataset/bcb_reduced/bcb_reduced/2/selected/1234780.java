...
public class ConfigurationData {
    ...
    /** Descripción de Campo */
    static String[] DBTYPE = new String[] { DBTYPE_POSTGRESQL };
    ...
    /** Descripción de Campo */
    private Config[] m_databaseConfig = new Config[] { new ConfigPostgreSQL(this), null, null, null };
    ...
    private void updateProperty(String property, String value) {
        ...
        if (currentValue == null) p_properties.put(property, value); else if (!currentValue.equals(value)) p_properties.put(property, value);
    }
    ...
    public void initAppsServer(int index) {
        if ((index < 0) || (index >= APPSTYPE.length)) {
            ...
            if (p_panel != null) p_panel.fAppsType.setSelectedIndex(0);
        } else {
            if (p_panel != null) m_appsConfig[index].init();
        }
    }
    ...
    public void initJava(int index) {
        if ((index < 0) || (index >= JAVATYPE.length)) {
            ...
            if (p_panel != null) p_panel.fJavaType.setSelectedIndex(0);
        } else {
            if (p_panel != null) m_javaConfig[index].init();
        }
    }
    ...
    public boolean load() {
        ...
        if (env.exists()) {
            ...
            if (loaded.containsKey(SERVIDOR_APPS_OXP)) setAppsServer((String) p_properties.get(SERVIDOR_APPS_OXP));
            if (loaded.containsKey(DEPLOY_APPS_OXP)) setAppsServerDeployDir((String) p_properties.get(DEPLOY_APPS_OXP));
            if (loaded.containsKey(PUERTO_JNP_OXP)) setAppsServerJNPPort((String) p_properties.get(PUERTO_JNP_OXP));
            if (loaded.containsKey(PUERTO_WEB_OXP)) setAppsServerWebPort((String) p_properties.get(PUERTO_WEB_OXP));
            if (loaded.containsKey(PUERTO_SSL_OXP)) setAppsServerSSLPort((String) p_properties.get(PUERTO_SSL_OXP));
            int dbTypeIndex = setDatabaseType((String) p_properties.get(TIPO_BD_OXP));
            initDatabase((String) p_properties.get(NOMBRE_BD_OXP), dbTypeIndex);
            if (loaded.containsKey(NOMBRE_BD_OXP)) setDatabaseDiscovered((String) p_properties.get(NOMBRE_BD_OXP));
            if (loaded.containsKey(SERVIDOR_BD_OXP)) setDatabaseServer((String) p_properties.get(SERVIDOR_BD_OXP));
            if (loaded.containsKey(PUERTO_BD_OXP)) setDatabasePort((String) p_properties.get(PUERTO_BD_OXP));
            if (loaded.containsKey(NOMBRE_BD_OXP)) setDatabaseName((String) p_properties.get(NOMBRE_BD_OXP));
            if (loaded.containsKey(USUARIO_BD_OXP)) setDatabaseUser((String) p_properties.get(USUARIO_BD_OXP));
            if (loaded.containsKey(PASSWD_BD_OXP)) setDatabasePassword((String) p_properties.get(PASSWD_BD_OXP));
            if (loaded.containsKey(SYSTEM_BD_OXP)) setDatabaseSystemPassword((String) p_properties.get(SYSTEM_BD_OXP));
            if (p_panel != null) {
    ...
    public boolean test() {
        ...
        if (p_panel != null) p_panel.setStatusBar(p_panel.lAppsServer.getText());
        error = testAppsServer();
        if (error != null) {
            log.severe(error);
            return false;
        }
        if (p_panel != null) p_panel.setStatusBar(p_panel.lDatabaseServer.getText());
        error = testDatabase();
        if (error != null) {
            log.severe(error);
            return false;
        }
        if (p_panel != null) p_panel.setStatusBar(p_panel.lMailServer.getText());
        error = testMail();
        if (error != null) {
            log.severe(error);
            return false;
    ...
    public String testAppsServer() {
        int index = p_panel != null ? p_panel.fAppsType.getSelectedIndex() : setAppsServerType((String) p_properties.get(TIPO_APPS_OXP));
        if ((index < 0) || (index >= APPSTYPE.length)) {
    ...
    public String testDatabase() {
        int index = p_panel != null ? p_panel.fDatabaseType.getSelectedIndex() : setDatabaseType((String) p_properties.get(TIPO_BD_OXP));
        if ((index < 0) || (index >= DBTYPE.length)) {
    ...
    public String testJava() {
        int index = p_panel != null ? p_panel.fJavaType.getSelectedIndex() : setJavaType((String) p_properties.get(JAVA_TYPE));
        if ((index < 0) || (index >= JAVATYPE.length)) {
    ...
    private String testMail() {
        String server = p_panel != null ? p_panel.fMailServer.getText() : (String) p_properties.get(SERVIDOR_MAIL_OXP);
        ...
        if (p_panel != null) p_panel.signalOK(p_panel.okMailServer, "ErrorMailServer", pass, true, error);
        if (!pass) {
            p_properties.setProperty(SERVIDOR_MAIL_OXP, "");
            return error;
        }
        p_properties.setProperty(SERVIDOR_MAIL_OXP, mailServer.getHostName());
        String mailUser = p_panel != null ? p_panel.fMailUser.getText() : (String) p_properties.get(USUARIO_MAIL_OXP);
        String mailPassword = p_panel != null ? new String(p_panel.fMailPassword.getPassword()) : (String) p_properties.get(PASSWORD_MAIL_OXP);
        p_properties.setProperty(USUARIO_MAIL_OXP, mailUser);
        p_properties.setProperty(PASSWORD_MAIL_OXP, mailPassword);
        String adminEMailString = p_panel != null ? p_panel.fAdminEMail.getText() : (String) p_properties.get(ADMIN_MAIL_OXP);
        ...
        if (p_panel != null) p_panel.signalOK(p_panel.okMailUser, "ErrorMail", pass, false, error);
        if (pass) {
    ...
    private boolean testMailServer(InetAddress mailServer, InternetAddress adminEMail, String mailUser, String mailPassword) {
        ...
        if (!smtpOK) {
            ...
            if (p_panel != null) p_panel.signalOK(p_panel.okMailServer, "ErrorMailServer", false, false, error);
            log.warning(error);
            return false;
        }
        try {
    ...
    private String testOXP() {
        ...
        if (p_panel != null) p_panel.signalOK(p_panel.okOXPHome, "ErrorOXPHome", pass, true, error);
        if (!pass) {
            return error;
        }
        ...
        String pw = p_panel != null ? new String(p_panel.fKeyStore.getPassword()) : (String) p_properties.get(KEYSTOREPASS_OXP);
        pass = (pw != null) && (pw.length() > 0);
        error = "Invalid Key Store Password = " + pw;
        if (p_panel != null) p_panel.signalOK(p_panel.okKeyStore, "KeyStorePassword", pass, true, error);
        if (!pass) {
            return error;
        }
        p_properties.setProperty(KEYSTOREPASS_OXP, pw);
        KeyStoreMgt ks = p_panel != null ? new KeyStoreMgt(fileName, p_panel.fKeyStore.getPassword()) : new KeyStoreMgt(fileName, pw.toCharArray());
        ...
        error = p_panel != null ? ks.verify((JFrame) SwingUtilities.getWindowAncestor(p_panel)) : ks.verify(null);
        pass = error == null;
        if (p_panel != null) p_panel.signalOK(p_panel.okKeyStore, "KeyStorePassword", pass, true, error);
        if (!pass) {
            return error;
    ...
    public String getAppsServer() {
        return p_panel != null ? p_panel.fAppsServer.getText() : (String) p_properties.get(SERVIDOR_APPS_OXP);
    }
    ...
    public String getAppsServerDeployDir() {
        return p_panel != null ? p_panel.fDeployDir.getText() : (String) p_properties.get(DEPLOY_APPS_OXP);
    }
    ...
    public int getAppsServerJNPPort() {
        String port = p_panel != null ? p_panel.fJNPPort.getText() : (String) p_properties.get(PUERTO_JNP_OXP);
        try {
    ...
    public int getAppsServerSSLPort() {
        String port = p_panel != null ? p_panel.fSSLPort.getText() : (String) p_properties.get(PUERTO_SSL_OXP);
        try {
            return Integer.parseInt(port);
        } catch (Exception e) {
    ...
    public String getAppsServerType() {
        return p_panel != null ? (String) p_panel.fAppsType.getSelectedItem() : (String) p_properties.get(TIPO_APPS_OXP);
    }
    ...
    public int getAppsServerWebPort() {
        String port = p_panel != null ? p_panel.fWebPort.getText() : (String) p_properties.get(PUERTO_WEB_OXP);
        try {
            return Integer.parseInt(port);
        } catch (Exception e) {
    ...
    public String getDatabaseName() {
        return p_panel != null ? p_panel.fDatabaseName.getText() : (String) p_properties.get(NOMBRE_BD_OXP);
    }
    ...
    public int getDatabasePort() {
        String port = p_panel != null ? p_panel.fDatabasePort.getText() : (String) p_properties.get(PUERTO_BD_OXP);
        try {
            return Integer.parseInt(port);
        } catch (Exception e) {
            setDatabasePort("0");
    ...
    public String getDatabaseServer() {
        return p_panel != null ? p_panel.fDatabaseServer.getText() : (String) p_properties.get(SERVIDOR_BD_OXP);
    }
    ...
    public String getDatabaseType() {
        return p_panel != null ? (String) p_panel.fDatabaseType.getSelectedItem() : (String) p_properties.get(TIPO_BD_OXP);
    }
    ...
    public String getDatabaseUser() {
        return p_panel != null ? p_panel.fDatabaseUser.getText() : (String) p_properties.get(USUARIO_BD_OXP);
    }
    ...
    public String getJavaHome() {
        return p_panel != null ? p_panel.fJavaHome.getText() : (String) p_properties.get(JAVA_HOME);
    }
    ...
    public String getJavaType() {
        return p_panel != null ? (String) p_panel.fJavaType.getSelectedItem() : (String) p_properties.get(JAVA_TYPE);
    }
    ...
    public String getOXPHome() {
        return p_panel != null ? p_panel.fOXPHome.getText() : (String) p_properties.get(OXP_HOME);
    }
    ...
    public int setAppsServerType(String appsType) {
        ...
        if (p_panel != null) p_panel.fAppsType.setSelectedIndex(index); else updateProperty(TIPO_APPS_OXP, appsType);
        return index;
    }
    ...
    public void setJavaHome(String javaHome) {
        if (p_panel != null) p_panel.fJavaHome.setText(javaHome); else updateProperty(JAVA_HOME, javaHome);
    }
    ...
    public int setJavaType(String javaType) {
        ...
        if (p_panel != null) p_panel.fJavaType.setSelectedIndex(index); else updateProperty(JAVA_TYPE, javaType);
        return index;
    }
