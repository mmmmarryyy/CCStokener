...
public class Voice {
   ...
   */
    ...
    static final String USER_AGENT = "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/525.13 (KHTML, like Gecko) Chrome/0.A.B.C Safari/525.13";
    ...
    public static final String HOSTED_OR_GOOGLE = "HOSTED_OR_GOOGLE";
	 ...
	 */
    static final String SERVICE = "grandcentral";

    /** The Constant generalURLString. */
    static final String generalURLString = "https://www.google.com/voice/b/0";

    /** The Constant loginURLString. */
    static final String loginURLString = "https://www.google.com/accounts/ClientLogin";

    /** The Constant inboxURLString. */
    static final String inboxURLString = "https://www.google.com/voice/b/0/inbox/recent/inbox/";

    /** The Constant starredURLString. */
    static final String starredURLString = "https://www.google.com/voice/b/0/inbox/recent/starred/";

    /** The Constant recentAllURLString. */
    static final String recentAllURLString = "https://www.google.com/voice/b/0/inbox/recent/all/";

    /** The Constant spamURLString. */
    static final String spamURLString = "https://www.google.com/voice/b/0/inbox/recent/spam/";

    /** The Constant trashURLString. */
    static final String trashURLString = "https://www.google.com/voice/b/0/inbox/recent/spam/";

    /** The Constant voicemailURLString. */
    static final String voicemailURLString = "https://www.google.com/voice/b/0/inbox/recent/voicemail/";

    /** The Constant smsURLString. */
    static final String smsURLString = "https://www.google.com/voice/b/0/inbox/recent/sms/";

    /** The Constant recordedURLString. */
    static final String recordedURLString = "https://www.google.com/voice/b/0/inbox/recent/recorded/";

    /** The Constant placedURLString. */
    static final String placedURLString = "https://www.google.com/voice/b/0/inbox/recent/placed/";

    /** The Constant receivedURLString. */
    static final String receivedURLString = "https://www.google.com/voice/b/0/inbox/recent/received/";

    /** The Constant missedURLString. */
    static final String missedURLString = "https://www.google.com/voice/b/0/inbox/recent/missed/";

    /** The Constant phoneEnableURLString. */
    static final String phoneEnableURLString = "https://www.google.com/voice/b/0/settings/editDefaultForwarding/";

    /** The Constant generalSettingsURLString. */
    static final String generalSettingsURLString = "https://www.google.com/voice/b/0/settings/editGeneralSettings/";

    /** The Constant phonesInfoURLString. */
    static final String phonesInfoURLString = "https://www.google.com/voice/b/0/settings/tab/phones";

    /** The Constant groupsInfoURLString. */
    static final String groupsInfoURLString = "https://www.google.com/voice/b/0/settings/tab/groups";

    /** The Constant voicemailInfoURLString. */
    static final String voicemailInfoURLString = "https://www.google.com/voice/b/0/settings/tab/voicemailsettings";

    /** The Constant groupsSettingsURLString. */
    static final String groupsSettingsURLString = "https://www.google.com/voice/b/0/settings/editGroup/";

    /** The Constant voicemailDownloadURLString. */
    static final String voicemailDownloadURLString = "https://www.google.com/voice/media/send_voicemail/";

    /** The Constant markAsReadString. */
    static final String markAsReadString = "https://www.google.com/voice/b/0/inbox/mark/";

    /** The Constant unreadSMSString. */
    static final String unreadSMSString = "https://www.google.com/voice/b/0/inbox/recent/sms/unread/";
	 ...
	 */
    @Deprecated
    public Voice(String user, String pass, String source, String rnrSee) throws IOException {
        this.user = user;
        this.pass = pass;
        this.rnrSEE = rnrSee;
        this.source = source;
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
    public Voice(String user, String pass, String source, boolean printDebugIntoToSystemOut) throws IOException {
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
    public Voice(String user, String pass, String source, boolean printDebugIntoToSystemOut, String accountType) throws IOException {
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
    public Voice(String user, String pass, String source, boolean printDebugIntoToSystemOut, String accountType, String captchaResponse, String captchaToken) throws IOException {
	 ...
	 */
    private void init(String user, String pass, String source, boolean printDebugIntoToSystemOut, String accountType, String captchaResponse, String captchaToken) throws IOException {
    ...
    private void setRNRSEE() throws IOException {
        if (general != null) {
            if (general.contains("'_rnr_se': '")) {
                ...
                rnrSEE = p1.split("',", 2)[0];
                if (PRINT_TO_CONSOLE) System.out.println("Successfully Received rnr_se.");
                p1 = null;
   ...
   */
    ...
    public void phonesEnable(int[] IDs) throws IOException {
        if (IDs.length < 1) {
            ...
            for (int i = 0; i < IDs.length; i++) {
                int j = IDs[i];
                String paraString = URLEncoder.encode("enabled", enc) + "=" + URLEncoder.encode("1", enc);
                paraString += "&" + URLEncoder.encode("phoneId", enc) + "=" + URLEncoder.encode(Integer.toString(j), enc);
    ...
    public String phoneEnable(int ID) throws IOException {
        String paraString = URLEncoder.encode("enabled", enc) + "=" + URLEncoder.encode("1", enc);
        paraString += "&" + URLEncoder.encode("phoneId", enc) + "=" + URLEncoder.encode(Integer.toString(ID), enc);
        paraString += "&" + URLEncoder.encode("_rnr_se", enc) + "=" + URLEncoder.encode(rnrSEE, enc);
    ...
    public void phonesDisable(int[] IDs) throws IOException {
        if (IDs.length < 1) {
            ...
            for (int i = 0; i < IDs.length; i++) {
                int j = IDs[i];
                String paraString = URLEncoder.encode("enabled", enc) + "=" + URLEncoder.encode("0", enc);
                paraString += "&" + URLEncoder.encode("phoneId", enc) + "=" + URLEncoder.encode(Integer.toString(j), enc);
                paraString += "&" + URLEncoder.encode("_rnr_se", enc) + "=" + URLEncoder.encode(rnrSEE, enc);
                phonesEnableDisableApply(paraString);
            }
    ...
    public String setVoicemailGreetingId(String greetingToSet) throws IOException {
        ...
        String paraString = "";
        paraString += URLEncoder.encode("greetingId", enc) + "=" + URLEncoder.encode(greetingToSet + "", enc);
        paraString += "&" + URLEncoder.encode("_rnr_se", enc) + "=" + URLEncoder.encode(rnrSEE, enc);
    ...
    public String setDoNotDisturb(boolean dndEnabled) throws IOException {
        ...
        String paraString = "";
        paraString += URLEncoder.encode("doNotDisturb", enc) + "=" + URLEncoder.encode(enabled + "", enc);
        paraString += "&" + URLEncoder.encode("_rnr_se", enc) + "=" + URLEncoder.encode(rnrSEE, enc);
        return postSettings(requestURL, paraString);
    }
    ...
    public String setNewGroupSettings(Group group) throws IOException {
        ...
        paraString += URLEncoder.encode("isCustomGreeting", enc) + "=" + URLEncoder.encode(isCustomGreeting + "", enc);
        int greetingId = group.getGreetingId();
        paraString += "&" + URLEncoder.encode("greetingId", enc) + "=" + URLEncoder.encode(greetingId + "", enc);
        for (int i = 0; i < group.getDisabledForwardingIds().size(); i++) {
            paraString += "&" + URLEncoder.encode("disabledPhoneIds", enc) + "=" + URLEncoder.encode(group.getDisabledForwardingIds().get(i).getId(), enc);
        }
        int directConnect = 0;
        if (group.isDirectConnect()) {
            directConnect = 1;
        }
        paraString += "&" + URLEncoder.encode("directConnect", enc) + "=" + URLEncoder.encode(directConnect + "", enc);
        int isCustomDirectConnect = 0;
        if (group.isCustomDirectConnect()) {
            isCustomDirectConnect = 1;
        }
        paraString += "&" + URLEncoder.encode("isCustomDirectConnect", enc) + "=" + URLEncoder.encode(isCustomDirectConnect + "", enc);
        int isCustomForwarding = 0;
        if (group.isCustomForwarding()) {
            isCustomForwarding = 1;
        }
        paraString += "&" + URLEncoder.encode("isCustomForwarding", enc) + "=" + URLEncoder.encode(isCustomForwarding + "", enc);
        paraString += "&" + URLEncoder.encode("id", enc) + "=" + URLEncoder.encode(group.getId(), enc);
        paraString += "&" + URLEncoder.encode("_rnr_se", enc) + "=" + URLEncoder.encode(rnrSEE, enc);
        return postSettings(requestURL, paraString);
    }
    ...
    private String postSettings(URL requestURL, String paraString) throws IOException {
        ...
        if (PRINT_TO_CONSOLE) System.out.println(requestURL + " - " + conn.getResponseMessage());
        InputStream is;
        if (responseCode == 200) {
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
    public String sendSMS(String destinationNumber, String txt, SMSThread thread) throws IOException {
    ...
    public boolean isLoggedIn() {
        ...
        if (res.contains("<meta name=\"description\" content=\"Google Voice gives you one number") && res.contains("action=\"https://www.google.com/accounts/ServiceLoginAuth?service=" + SERVICE + "\"")) {
            return false;
        } else {
