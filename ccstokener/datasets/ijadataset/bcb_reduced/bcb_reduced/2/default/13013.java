...
class Form {
    ...
    public void setMethod(String m) {
        if (m.toLowerCase().equals("GET") || m.toLowerCase().equals("POST")) method = m.toUpperCase();
    }
    ...
    public void send() {
        try {
            ...
            while (i.hasNext()) {
                ...
                if (f.flood_type.type == Flood.INT) f.flood_value = generateRandomInt(len); else if (f.flood_type.type == Flood.EMAIL) f.flood_value = generateRandomEmail(); else if (f.flood_type.type == Flood.STR) f.flood_value = generateRandomString(len); else if (f.flood_type.type == Flood.SELECT) {
            ...
            if (method.toUpperCase().equals("POST")) sendViaPOST(url); else sendViaGET(url);
